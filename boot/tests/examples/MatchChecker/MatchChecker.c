...
next_95:;
    ...
    if (!((dominant_ == 1))) goto next_104;
    match_29 = spaceEmpty_;
    goto end_match_103;
next_104:;
    if (!((dominant_ == 0))) goto next_105;
...
int fun_7(struct StringSpace_Tuple2 arg_68) {
    ...
    int match_33;
    if (!(((str_cmp(actual_, expected_) == 0) == 1))) goto next_126;
    match_33 = 1;
    goto end_match_125;
next_126:;
    if (!(((str_cmp(actual_, expected_) == 0) == 0))) goto next_127;
...
int fun_8(struct Space_Space_Tuple2 arg_71, struct StringTy_Pat_ListCovering_Tuple4 arg_72) {
    ...
    if (!((call_179 == 1))) goto next_129;
    match_34 = (struct Covering_){.tag = Covering_};
    goto end_match_128;
next_129:;
    if (!((call_179 == 0))) goto next_130;
...
int main() {
    ...
    int ok_1 = call_189;
    int match_37;
    if (!((ok_1 == 1))) goto next_141;
    match_37 = 0;
    goto end_match_140;
next_141:;
    if (!((ok_1 == 0))) goto next_142;
    match_37 = 1;
    goto end_match_140;
next_142:;
    exit(1);
