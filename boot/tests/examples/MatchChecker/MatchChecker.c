...
int fun_(struct Space_Tuple1 arg_49, struct Space_Space_Tuple2 arg_50);
...
struct Space_ fun_2(struct Space_IntTuple2 arg_51, int j_, struct Space_Space_Tuple2 arg_52);
...
struct Space_ fun_28(struct Space_StringSpace_ListSpace_ListTuple4 arg_53, int i_1, struct Space_ __14);
...
struct Space_ fun_3(struct Space_Space_Tuple2 arg_54, struct Space_ first_3);

struct Space_Space_Tuple2Tuple1;

struct Space_ fun_15(void* env_6, struct Space_ arg_13);

struct Space_ spaceExclude_(struct Space_Tuple1 arg_55, struct Space_ first_, struct Space_ second_);

int spaceCovers_(struct Space_Tuple1 arg_56, struct Space_ other_, struct Space_ cover_);
...
next_2:;
    ...
    list_1->head = x_2;
    list_1->tail = acc_;
    struct Space_List* call_4 = go_27(list_1, xs_3);
    match_ = call_4;
    goto end_match_1;
next_3:;
    exit(1);
...
next_5:;
    ...
    list_2->head = x_2;
    list_2->tail = acc_;
    struct StringList* call_5 = go_26(list_2, xs_3);
    match_1 = call_5;
    goto end_match_4;
next_6:;
    exit(1);
...
next_8:;
    ...
    list_3->head = x_2;
    list_3->tail = acc_;
    struct BoolList* call_6 = go_29(list_3, xs_3);
    match_2 = call_6;
    goto end_match_7;
next_9:;
    exit(1);
...
next_11:;
    ...
    list_4->head = x_2;
    list_4->tail = acc_;
    struct Space_Space_Tuple2List* call_7 = go_28(list_4, xs_3);
    match_3 = call_7;
    goto end_match_10;
next_12:;
    exit(1);
...
struct Space_List* listRev_2(struct Space_List* xs_1) {
    struct Space_List* call_8 = go_27(NULL, xs_1);
    return call_8;
}

struct StringList* listRev_1(struct StringList* xs_1) {
    struct StringList* call_9 = go_26(NULL, xs_1);
    return call_9;
}

struct BoolList* listRev_4(struct BoolList* xs_1) {
    struct BoolList* call_10 = go_29(NULL, xs_1);
    return call_10;
}

struct Space_Space_Tuple2List* listRev_3(struct Space_Space_Tuple2List* xs_1) {
    struct Space_Space_Tuple2List* call_11 = go_28(NULL, xs_1);
    return call_11;
}
...
next_14:;
    ...
    list_5->head = app_;
    list_5->tail = acc_1;
    struct Space_List* call_13 = go_25(tuple_, list_5, xs_6);
    match_4 = call_13;
    goto end_match_13;
next_15:;
    exit(1);
...
next_17:;
    ...
    list_6->head = app_1;
    list_6->tail = acc_1;
    struct Space_List* call_15 = go_24(tuple_1, list_6, xs_6);
    match_5 = call_15;
    goto end_match_16;
next_18:;
    exit(1);
...
next_20:;
    ...
    list_7->head = app_2;
    list_7->tail = acc_1;
    struct Space_List* call_17 = go_23(tuple_2, list_7, xs_6);
    match_6 = call_17;
    goto end_match_19;
next_21:;
    exit(1);
...
next_23:;
    ...
    list_8->head = app_3;
    list_8->tail = acc_1;
    struct BoolList* call_19 = go_22(tuple_3, list_8, xs_6);
    match_7 = call_19;
    goto end_match_22;
next_24:;
    exit(1);
...
next_26:;
    ...
    list_9->head = app_4;
    list_9->tail = acc_1;
    struct BoolList* call_21 = go_21(tuple_4, list_9, xs_6);
    match_8 = call_21;
    goto end_match_25;
next_27:;
    exit(1);
...
struct Space_List* listMap_5(struct Space_Space_Fun1 f_, struct Space_List* xs_4) {
    ...
    tuple_5.t0 = f_;
    struct Space_List* call_22 = go_25(tuple_5, NULL, xs_4);
    return call_22;
}
...
struct Space_List* listMap_4(struct Ty_Space_Fun1 f_, struct Ty_List* xs_4) {
    ...
    tuple_6.t0 = f_;
    struct Space_List* call_23 = go_24(tuple_6, NULL, xs_4);
    return call_23;
}
...
struct Space_List* listMap_3(struct Pat_Space_Fun1 f_, struct Pat_List* xs_4) {
    ...
    tuple_7.t0 = f_;
    struct Space_List* call_24 = go_23(tuple_7, NULL, xs_4);
    return call_24;
}
...
struct BoolList* listMap_2(struct StringSpace_Tuple2BoolFun1 f_, struct StringSpace_Tuple2List* xs_4) {
    ...
    tuple_8.t0 = f_;
    struct BoolList* call_25 = go_22(tuple_8, NULL, xs_4);
    return call_25;
}
...
struct BoolList* listMap_1(struct StringTy_Pat_ListCovering_Tuple4BoolFun1 f_, struct StringTy_Pat_ListCovering_Tuple4List* xs_4) {
    ...
    tuple_9.t0 = f_;
    struct BoolList* call_26 = go_21(tuple_9, NULL, xs_4);
    return call_26;
}
...
next_29:;
    ...
    list_10->head = app_5;
    list_10->tail = acc_2;
    struct Space_List* call_28 = go_20(tuple_10, list_10, (i_ + 1), xs_9);
    match_9 = call_28;
    goto end_match_28;
next_30:;
    exit(1);
...
next_32:;
    ...
    list_11->head = app_6;
    list_11->tail = acc_2;
    struct Space_List* call_30 = go_19(tuple_11, list_11, (i_ + 1), xs_9);
    match_10 = call_30;
    goto end_match_31;
next_33:;
    exit(1);
...
struct Space_List* listMapWithIndex_2(struct IntSpace_Space_Tuple2Space_Fun2 f_1, struct Space_Space_Tuple2List* xs_7) {
    ...
    tuple_12.t0 = f_1;
    struct Space_List* call_31 = go_20(tuple_12, NULL, 0, xs_7);
    return call_31;
}
...
struct Space_List* listMapWithIndex_1(struct IntSpace_Space_Fun2 f_1, struct Space_List* xs_7) {
    ...
    tuple_13.t0 = f_1;
    struct Space_List* call_32 = go_19(tuple_13, NULL, 0, xs_7);
    return call_32;
}
...
next_35:;
    ...
    tuple_14.t0 = p_;
    int call_33 = go_18(tuple_14, xs_12);
    match_12 = call_33;
    goto end_match_37;
next_38:;
...
next_41:;
    ...
    tuple_15.t0 = p_;
    int call_34 = go_17(tuple_15, xs_12);
    match_14 = call_34;
    goto end_match_43;
next_44:;
...
next_47:;
    ...
    tuple_16.t0 = p_;
    int call_35 = go_16(tuple_16, xs_12);
    match_16 = call_35;
    goto end_match_49;
next_50:;
...
int listForAll_3(struct Space_BoolFun1 p_, struct Space_List* xs_10) {
    ...
    tuple_17.t0 = p_;
    int call_36 = go_18(tuple_17, xs_10);
    return call_36;
}
...
int listForAll_2(struct Space_Space_Tuple2BoolFun1 p_, struct Space_Space_Tuple2List* xs_10) {
    ...
    tuple_18.t0 = p_;
    int call_37 = go_17(tuple_18, xs_10);
    return call_37;
}
...
int listForAll_1(struct BoolBoolFun1 p_, struct BoolList* xs_10) {
    ...
    tuple_19.t0 = p_;
    int call_38 = go_16(tuple_19, xs_10);
    return call_38;
}
...
next_53:;
    ...
    if (!((app_10 == 1))) goto next_56;
    match_18 = 1;
    goto end_match_55;
next_56:;
    if (!((app_10 == 0))) goto next_57;
    struct Space_BoolFun1Tuple1 tuple_20;
    tuple_20.t0 = p_1;
    int call_39 = go_15(tuple_20, xs_15);
    match_18 = call_39;
    goto end_match_55;
next_57:;
    exit(1);
...
int listExists_1(struct Space_BoolFun1 p_1, struct Space_List* xs_13) {
    ...
    tuple_21.t0 = p_1;
    int call_40 = go_15(tuple_21, xs_13);
    return call_40;
}
...
next_59:;
    ...
    struct Space_ call_41 = go_14(tuple_22, app_11, xs_18);
    match_19 = call_41;
    goto end_match_58;
next_60:;
    exit(1);
...
next_62:;
    ...
    struct StringList* call_42 = go_13(tuple_23, app_12, xs_18);
    match_20 = call_42;
    goto end_match_61;
next_63:;
    exit(1);
...
struct Space_ listFold_2(struct Space_Space_Space_Fun2 folder_, struct Space_ state_, struct Space_List* xs_16) {
    ...
    tuple_24.t0 = folder_;
    struct Space_ call_43 = go_14(tuple_24, state_, xs_16);
    return call_43;
}
...
struct StringList* listFold_1(struct StringListSpace_StringListFun2 folder_, struct StringList* state_, struct Space_List* xs_16) {
    ...
    tuple_25.t0 = folder_;
    struct StringList* call_44 = go_13(tuple_25, state_, xs_16);
    return call_44;
}
...
next_67:;
    ...
    list_12->tail = acc_3;
    struct Space_Space_Tuple2List* call_46 = go_12(list_12, xs_21, ys_2);
    match_21 = call_46;
    goto end_match_64;
next_68:;
    exit(1);
...
struct Space_Space_Tuple2List* listZip_1(struct Space_List* xs_19, struct Space_List* ys_) {
    struct Space_Space_Tuple2List* call_47 = go_12(NULL, xs_19, ys_);
    return call_47;
}
...
next_70:;
    ...
    struct String call_48 = go_7(xs_24);
    match_22 = str_add(x_9, call_48);
    goto end_match_69;
next_71:;
    exit(1);
end_match_69:;
...
struct String strConcat_(struct StringList* xs_22) {
    struct String call_49 = go_7(xs_22);
    return call_49;
}
...
next_73:;
    ...
    struct Space_List* call_51 = go_8(subspaces_, acc_4);
    struct Space_List* call_52 = go_8(spaces_2, call_51);
    match_23 = call_52;
    goto end_match_72;
next_74:;
    ...
    if (!(call_53)) goto next_75;
    struct Space_List* call_54 = go_8(spaces_3, acc_4);
    match_23 = call_54;
    goto end_match_72;
next_75:;
    ...
    list_13->tail = acc_4;
    struct Space_List* call_55 = go_8(spaces_4, list_13);
    match_23 = call_55;
    goto end_match_72;
next_76:;
...
struct Space_ spaceUnion_(struct Space_List* spaces_) {
    ...
    struct Space_List* call_57 = go_8(spaces_, NULL);
    if (!((!((!(call_57)))))) goto next_79;
    struct Space_ space_2 = call_57->head;
    if (!((!(call_57->tail)))) goto next_79;
    match_24 = space_2;
    goto end_match_78;
next_79:;
...
int fun_9(void* env_, struct Space_ arg_) {
    int call_58 = spaceIsEmpty_(arg_);
    return call_58;
}

int fun_10(void* env_1, struct Space_ arg_1) {
    int call_59 = spaceIsEmpty_(arg_1);
    return call_59;
}

int spaceIsEmpty_(struct Space_ space_3) {
    int match_25;
    if (!((space_3.tag == Full_))) goto next_83;
    goto match_body_82;
next_83:;
    if (!((space_3.tag == Ref_))) goto next_84;
    goto match_body_82;
match_body_82:;
    match_25 = 0;
    goto end_match_81;
next_84:;
    if (!((space_3.tag == Ctor_))) goto next_85;
    ...
    int call_60 = listExists_1(fun_29, spaces_6);
    match_25 = call_60;
    goto end_match_81;
next_85:;
    if (!((space_3.tag == Union_))) goto next_86;
    ...
    int call_61 = listForAll_3(fun_30, spaces_7);
    match_25 = call_61;
    goto end_match_81;
next_86:;
...
struct Space_ spaceDecompose_(struct Space_ space_4) {
    ...
    if (!((space_4.tag == Ref_))) goto next_89;
...
int fun_(struct Space_Tuple1 arg_49, struct Space_Space_Tuple2 arg_50) {
    struct Space_ spaceEmpty_ = arg_49.t0;
...
int fun_11(void* env_2, struct Space_Space_Tuple2 arg_2) {
    struct Space_Tuple1 arg_3 = (*(((struct Space_Tuple1Tuple1*)env_2))).t0;
    int call_67 = fun_(arg_3, arg_2);
    return call_67;
}
...
struct Space_ fun_12(void* env_3, int arg_4, struct Space_Space_Tuple2 arg_5) {
    struct Space_IntTuple2 arg_6 = (*(((struct Space_IntTuple2Tuple1*)env_3))).t0;
    struct Space_ call_69 = fun_2(arg_6, arg_4, arg_5);
    return call_69;
}
...
struct Space_ fun_28(struct Space_StringSpace_ListSpace_ListTuple4 arg_53, int i_1, struct Space_ __14) {
    struct Space_ spaceEmpty_ = arg_53.t0;
    struct String tag_2 = arg_53.t1;
    struct Space_List* firsts_ = arg_53.t2;
    struct Space_List* seconds_ = arg_53.t3;
    struct Space_IntTuple2 tuple_33;
    tuple_33.t0 = spaceEmpty_;
    tuple_33.t1 = i_1;
    struct Space_IntTuple2Tuple1 tuple_32;
    tuple_32.t0 = tuple_33;
    void* box_2 = (void*)malloc(sizeof(struct Space_IntTuple2Tuple1));
    (*(((struct Space_IntTuple2Tuple1*)box_2))) = tuple_32;
    void* env_21 = box_2;
    ...
    struct Space_List* call_71 = listMapWithIndex_2(fun_31, call_70);
...
struct Space_ fun_13(void* env_4, int arg_7, struct Space_ arg_8) {
    struct Space_StringSpace_ListSpace_ListTuple4 arg_9 = (*(((struct Space_StringSpace_ListSpace_ListTuple4Tuple1*)env_4))).t0;
    struct Space_ call_73 = fun_28(arg_9, arg_7, arg_8);
    return call_73;
}

struct Space_ fun_14(void* env_5, struct Space_ arg_10, struct Space_ arg_11) {
    struct Space_Tuple1 arg_12 = (*(((struct Space_Tuple1Tuple1*)env_5))).t0;
    struct Space_ call_74 = spaceExclude_(arg_12, arg_10, arg_11);
    return call_74;
}

struct Space_ fun_3(struct Space_Space_Tuple2 arg_54, struct Space_ first_3) {
    struct Space_ spaceEmpty_ = arg_54.t0;
    struct Space_ second_ = arg_54.t1;
...
struct Space_ fun_15(void* env_6, struct Space_ arg_13) {
    struct Space_Space_Tuple2 arg_14 = (*(((struct Space_Space_Tuple2Tuple1*)env_6))).t0;
    struct Space_ call_76 = fun_3(arg_14, arg_13);
    return call_76;
}
...
struct Space_ spaceExclude_(struct Space_Tuple1 arg_55, struct Space_ first_, struct Space_ second_) {
    ...
    if (!((!((*(tuple_35.t0.Union_)))))) goto next_95;
    match_28 = spaceEmpty_;
    goto end_match_94;
next_95:;
    if (!((tuple_35.t1.tag == Union_))) goto next_96;
    if (!((!((*(tuple_35.t1.Union_)))))) goto next_96;
    match_28 = first_;
    goto end_match_94;
next_96:;
    if (!((tuple_35.t1.tag == Full_))) goto next_97;
    match_28 = spaceEmpty_;
    goto end_match_94;
next_97:;
    if (!((tuple_35.t0.tag == Ctor_))) goto next_98;
    struct String tag_2 = (*(tuple_35.t0.Ctor_)).t0;
    struct Space_List* firsts_ = (*(tuple_35.t0.Ctor_)).t1;
    if (!((tuple_35.t1.tag == Ctor_))) goto next_98;
    struct String secondTag_ = (*(tuple_35.t1.Ctor_)).t0;
    struct Space_List* seconds_ = (*(tuple_35.t1.Ctor_)).t1;
    if (!((str_cmp(tag_2, secondTag_) == 0))) goto next_98;
    struct Space_Tuple1 tuple_37;
    tuple_37.t0 = spaceEmpty_;
    struct Space_Tuple1Tuple1 tuple_36;
    tuple_36.t0 = tuple_37;
    void* box_3 = (void*)malloc(sizeof(struct Space_Tuple1Tuple1));
    (*(((struct Space_Tuple1Tuple1*)box_3))) = tuple_36;
    void* env_22 = box_3;
    ...
    int call_78 = listForAll_2(fun_32, call_77);
    int dominant_ = call_78;
    struct Space_ match_29;
    if (!((dominant_ == 1))) goto next_106;
    match_29 = spaceEmpty_;
    goto end_match_105;
next_106:;
    if (!((dominant_ == 0))) goto next_107;
    ...
    void* box_4 = (void*)malloc(sizeof(struct Space_StringSpace_ListSpace_ListTuple4Tuple1));
    (*(((struct Space_StringSpace_ListSpace_ListTuple4Tuple1*)box_4))) = tuple_38;
    void* env_23 = box_4;
    struct IntSpace_Space_Fun2 fun_33 = (struct IntSpace_Space_Fun2){.fun = fun_13, .env = env_23};
    struct Space_List* call_79 = listMapWithIndex_1(fun_33, firsts_);
...
end_match_105:;
    ...
    goto end_match_94;
next_98:;
    if (!((tuple_35.t0.tag == Ctor_))) goto next_99;
    if (!((tuple_35.t1.tag == Ctor_))) goto next_99;
    match_28 = first_;
    goto end_match_94;
next_99:;
    if (!((tuple_35.t1.tag == Union_))) goto next_100;
    ...
    void* box_5 = (void*)malloc(sizeof(struct Space_Tuple1Tuple1));
    (*(((struct Space_Tuple1Tuple1*)box_5))) = tuple_40;
    void* env_24 = box_5;
    struct Space_Space_Space_Fun2 fun_34 = (struct Space_Space_Space_Fun2){.fun = fun_14, .env = env_24};
    struct Space_ call_81 = listFold_2(fun_34, first_, seconds_1);
    match_28 = call_81;
    goto end_match_94;
next_100:;
    if (!((tuple_35.t0.tag == Union_))) goto next_101;
    ...
    void* box_6 = (void*)malloc(sizeof(struct Space_Space_Tuple2Tuple1));
    (*(((struct Space_Space_Tuple2Tuple1*)box_6))) = tuple_42;
    void* env_25 = box_6;
    struct Space_Space_Fun1 fun_35 = (struct Space_Space_Fun1){.fun = fun_15, .env = env_25};
    struct Space_List* call_82 = listMap_5(fun_35, firsts_1);
    struct Space_ call_83 = spaceUnion_(call_82);
    match_28 = call_83;
    goto end_match_94;
next_101:;
    if (!((tuple_35.t0.tag == Ref_))) goto next_102;
    ...
    if (!((str_cmp(tag_3, secondTag_1) == 0))) goto next_102;
    match_28 = spaceEmpty_;
    goto end_match_94;
next_102:;
    if (!((tuple_35.t0.tag == Ref_))) goto next_103;
...
struct StringList* fun_4(struct StringList* acc_7, struct Space_ space_8) {
    ...
    struct StringList* call_92 = go_9(space_8, call_91);
    return call_92;
}

struct StringList* fun_16(void* env_7, struct StringList* arg_15, struct Space_ arg_16) {
    struct StringList* call_93 = fun_4(arg_15, arg_16);
    return call_93;
}

struct StringList* fun_5(struct StringList* acc_9, struct Space_ space_9) {
    struct StringList* call_94 = cons_1((struct String){.str = ", ", .len = 2}, acc_9);
    struct StringList* call_95 = go_9(space_9, call_94);
    return call_95;
}

struct StringList* fun_17(void* env_8, struct StringList* arg_17, struct Space_ arg_18) {
    struct StringList* call_96 = fun_5(arg_17, arg_18);
    return call_96;
}

struct StringList* go_9(struct Space_ space_7, struct StringList* acc_5) {
    struct StringList* match_30;
    if (!((space_7.tag == Full_))) goto next_109;
    struct StringList* call_97 = cons_1((struct String){.str = "full", .len = 4}, acc_5);
    match_30 = call_97;
    goto end_match_108;
next_109:;
    if (!((space_7.tag == Ctor_))) goto next_110;
    struct String tag_4 = (*(space_7.Ctor_)).t0;
    if (!((!((*(space_7.Ctor_)).t1)))) goto next_110;
    struct StringList* call_98 = cons_1(tag_4, acc_5);
    match_30 = call_98;
    goto end_match_108;
next_110:;
    if (!((space_7.tag == Ctor_))) goto next_111;
    struct String tag_5 = (*(space_7.Ctor_)).t0;
    if (!((!((!((*(space_7.Ctor_)).t1)))))) goto next_111;
    ...
    struct StringList* call_101 = go_9(item_, call_100);
    ...
    struct StringList* call_102 = listFold_1(fun_36, acc_6, items_1);
    struct StringList* call_103 = cons_1((struct String){.str = ")", .len = 1}, call_102);
    match_30 = call_103;
    goto end_match_108;
next_111:;
    if (!((space_7.tag == Ref_))) goto next_112;
    struct String tag_6 = (*(space_7.Ref_)).t0;
    struct StringList* call_104 = cons_1(tag_6, acc_5);
    match_30 = call_104;
    goto end_match_108;
next_112:;
    if (!((space_7.tag == Union_))) goto next_113;
    if (!((!((*(space_7.Union_)))))) goto next_113;
    struct StringList* call_105 = cons_1((struct String){.str = "empty", .len = 5}, acc_5);
    match_30 = call_105;
    goto end_match_108;
next_113:;
    if (!((space_7.tag == Union_))) goto next_114;
    if (!((!((!((*(space_7.Union_)))))))) goto next_114;
    struct Space_ subspace_ = (*(space_7.Union_))->head;
    struct Space_List* subspaces_1 = (*(space_7.Union_))->tail;
    struct StringList* call_106 = cons_1((struct String){.str = "+(", .len = 2}, acc_5);
    struct StringList* call_107 = go_9(subspace_, call_106);
    struct StringList* acc_8 = call_107;
    ...
    struct StringList* call_108 = listFold_1(fun_37, acc_8, subspaces_1);
    struct StringList* call_109 = cons_1((struct String){.str = ")", .len = 1}, call_108);
    match_30 = call_109;
    goto end_match_108;
next_114:;
    struct StringList* call_110 = failwith_2((struct String){.str = "NEVER: suppress warning", .len = 23});
    match_30 = call_110;
    goto end_match_108;
next_115:;
end_match_108:;
...
struct String spaceToString_(struct Space_ space_6) {
    struct StringList* call_111 = go_9(space_6, NULL);
    struct StringList* call_112 = listRev_1(call_111);
    struct String call_113 = strConcat_(call_112);
    return call_113;
}

struct Space_ fun_18(void* env_9, struct Ty_ arg_19) {
    struct Space_Tuple1 arg_20 = (*(((struct Space_Tuple1Tuple1*)env_9))).t0;
    struct Space_ call_114 = go_10(arg_20, arg_19);
    return call_114;
}

struct Space_ fun_19(void* env_10, int arg_21) {
    struct Space_Tuple1 arg_22 = (*(((struct Space_Tuple1Tuple1*)env_10))).t0;
    struct Space_ call_115 = thunk_2(arg_22, 0);
    return call_115;
}

struct Space_ thunk_2(struct Space_Tuple1 arg_57, int arg_58) {
    struct Space_ itemSpace_ = arg_57.t0;
    struct Space_ call_116 = spaceCtor_((struct String){.str = "nil", .len = 3}, NULL);
...
struct Space_ go_10(struct Space_Tuple1 arg_59, struct Ty_ ty_1) {
    ...
    if (!((ty_1.tag == Int_))) goto next_117;
    match_31 = spaceFull_;
    goto end_match_116;
next_117:;
    if (!((ty_1.tag == Tuple_))) goto next_118;
    ...
    struct Space_List* call_121 = listMap_4(fun_39, itemTys_);
    struct Space_ call_122 = spaceCtor_((struct String){.str = "tuple", .len = 5}, call_121);
    match_31 = call_122;
    goto end_match_116;
next_118:;
    if (!((ty_1.tag == List_))) goto next_119;
    struct Ty_ itemTy_ = (*(ty_1.List_));
    struct Space_Tuple1 tuple_51;
    tuple_51.t0 = spaceFull_;
    struct Space_ call_123 = go_10(tuple_51, itemTy_);
    struct Space_ itemSpace_ = call_123;
    ...
    struct Space_ call_124 = spaceRef_((struct String){.str = "list", .len = 4}, fun_40);
    match_31 = call_124;
    goto end_match_116;
next_119:;
    struct Space_ call_125 = failwith_1((struct String){.str = "NEVER", .len = 5});
    match_31 = call_125;
    goto end_match_116;
next_120:;
end_match_116:;
...
struct Space_ tyToSpace_(struct Space_Tuple1 arg_60, struct Ty_ ty_) {
    ...
    struct Space_ call_126 = go_10(tuple_54, ty_);
    return call_126;
}

struct Space_ fun_21(void* env_12, struct Pat_ arg_25) {
    struct Space_Space_Tuple2 arg_26 = (*(((struct Space_Space_Tuple2Tuple1*)env_12))).t0;
    struct Space_ call_127 = go_11(arg_26, arg_25);
    return call_127;
}
...
struct Space_ go_11(struct Space_Space_Tuple2 arg_61, struct Pat_ pat_1) {
    ...
    if (!((pat_1.tag == Discard_))) goto next_122;
    match_32 = spaceFull_;
    goto end_match_121;
next_122:;
    if (!((pat_1.tag == IntLit_))) goto next_123;
    match_32 = spaceEmpty_;
    goto end_match_121;
next_123:;
    if (!((pat_1.tag == TupleLit_))) goto next_124;
    ...
    struct Space_List* call_128 = listMap_3(fun_41, itemPats_);
    struct Space_ call_129 = spaceCtor_((struct String){.str = "tuple", .len = 5}, call_128);
    match_32 = call_129;
    goto end_match_121;
next_124:;
    if (!((pat_1.tag == Nil_))) goto next_125;
    struct Space_ call_130 = spaceCtor_((struct String){.str = "nil", .len = 3}, NULL);
    match_32 = call_130;
    goto end_match_121;
next_125:;
    if (!((pat_1.tag == Cons_))) goto next_126;
    ...
    struct Space_ call_131 = go_11(tuple_57, headPat_);
    struct Space_Space_Tuple2 tuple_58;
    tuple_58.t0 = spaceFull_;
    tuple_58.t1 = spaceEmpty_;
    struct Space_ call_132 = go_11(tuple_58, tailPat_);
    struct Space_List* list_19 = (struct Space_List*)malloc(sizeof(struct Space_List));
    list_19->head = call_132;
    list_19->tail = NULL;
    struct Space_List* list_18 = (struct Space_List*)malloc(sizeof(struct Space_List));
    list_18->head = call_131;
    list_18->tail = list_19;
    struct Space_ call_133 = spaceCtor_((struct String){.str = "cons", .len = 4}, list_18);
    match_32 = call_133;
    goto end_match_121;
next_126:;
    struct Space_ call_134 = failwith_1((struct String){.str = "NEVER", .len = 5});
    match_32 = call_134;
    goto end_match_121;
next_127:;
end_match_121:;
...
struct Space_ patToSpace_(struct Space_Space_Tuple2 arg_62, struct Pat_ pat_) {
    ...
    struct Space_ call_135 = go_11(tuple_59, pat_);
    return call_135;
}

struct Space_ fun_22(void* env_13, struct Pat_ arg_27) {
    struct Space_Space_Tuple2 arg_28 = (*(((struct Space_Space_Tuple2Tuple1*)env_13))).t0;
    struct Space_ call_136 = patToSpace_(arg_28, arg_27);
    return call_136;
}
...
struct Space_ patsToSpace_(struct Space_Space_Tuple2 arg_63, struct Pat_List* pats_) {
    ...
    struct Space_List* call_137 = listMap_3(fun_42, pats_);
    struct Space_ call_138 = spaceUnion_(call_137);
    return call_138;
}
...
struct Space_ fun_23(void* env_14, int arg_29) {
    ...
    struct Space_ call_139 = fun_6(arg_30, 0);
    return call_139;
}
...
int fun_7(struct StringSpace_Tuple2 arg_68) {
    ...
    struct String call_167 = spaceToString_(space_10);
    struct String actual_ = call_167;
    int match_33;
    if (!(((str_cmp(actual_, expected_) == 0) == 1))) goto next_129;
    match_33 = 1;
    goto end_match_128;
next_129:;
    if (!(((str_cmp(actual_, expected_) == 0) == 0))) goto next_130;
...
int testSpaceToString_(struct Space_Space_Tuple2 arg_69, int arg_70) {
    ...
    struct Space_ call_170 = spaceCtor_((struct String){.str = "nil", .len = 3}, NULL);
    struct StringSpace_Tuple2 tuple_68;
    tuple_68.t0 = (struct String){.str = "nil", .len = 3};
    tuple_68.t1 = call_170;
    ...
    struct Space_ call_173 = tyToSpace_(tuple_73, variant_6);
    struct Space_ call_174 = spaceDecompose_(call_173);
    struct StringSpace_Tuple2 tuple_72;
    tuple_72.t0 = (struct String){.str = "+(nil, cons(full, list))", .len = 24};
    tuple_72.t1 = call_174;
...
int fun_8(struct Space_Space_Tuple2 arg_71, struct StringTy_Pat_ListCovering_Tuple4 arg_72) {
    ...
    struct Space_ call_180 = tyToSpace_(tuple_77, ty_2);
    struct Space_ tySpace_ = call_180;
    struct Space_Space_Tuple2 tuple_78;
    tuple_78.t0 = spaceFull_;
    tuple_78.t1 = spaceEmpty_;
    struct Space_ call_181 = patsToSpace_(tuple_78, pats_1);
    struct Space_ patSpace_ = call_181;
    struct Covering_ match_34;
    struct Space_Tuple1 tuple_79;
    tuple_79.t0 = spaceEmpty_;
    int call_182 = spaceCovers_(tuple_79, tySpace_, patSpace_);
    if (!((call_182 == 1))) goto next_132;
    match_34 = (struct Covering_){.tag = Covering_};
    goto end_match_131;
next_132:;
    if (!((call_182 == 0))) goto next_133;
...
end_match_131:;
    ...
    if (!((tuple_80.t0.tag == Covering_))) goto next_136;
    if (!((tuple_80.t1.tag == Covering_))) goto next_136;
    goto match_body_135;
next_136:;
    if (!((tuple_80.t0.tag == Open_))) goto next_137;
    if (!((tuple_80.t1.tag == Open_))) goto next_137;
    goto match_body_135;
match_body_135:;
    ...
    goto end_match_134;
next_137:;
    if (!((tuple_80.t0.tag == Covering_))) goto next_138;
    if (!((tuple_80.t1.tag == Open_))) goto next_138;
...
end_match_134:;
    ...
    int call_183 = 0;
    int match_36;
    if (!(((!(ok_2)) == 1))) goto next_141;
    struct String call_184 = spaceToString_(tySpace_);
    printf("  ty: %s\n", call_184.str);
    int call_185 = 0;
    struct String call_186 = spaceToString_(patSpace_);
    printf("  pats: %s\n", call_186.str);
    int call_187 = 0;
    match_36 = 0;
    goto end_match_140;
next_141:;
    if (!(((!(ok_2)) == 0))) goto next_142;
    match_36 = 0;
    goto end_match_140;
next_142:;
    exit(1);
...
int fun_27(void* env_18, struct StringTy_Pat_ListCovering_Tuple4 arg_34) {
    ...
    int call_188 = fun_8(arg_35, arg_34);
    return call_188;
}
...
int main() {
    ...
    int call_189 = testSpaceIsEmpty_(tuple_84, 0);
    struct Space_Space_Tuple2 tuple_85;
    tuple_85.t0 = spaceFull_;
    tuple_85.t1 = spaceEmpty_;
    int call_190 = testSpaceToString_(tuple_85, 0);
    ...
    struct BoolList* call_191 = listMap_1(fun_47, testCases_);
    int call_192 = listForAll_1(fun_46, call_191);
    int ok_1 = call_192;
    int match_37;
    if (!((ok_1 == 1))) goto next_144;
    match_37 = 0;
    goto end_match_143;
next_144:;
    if (!((ok_1 == 0))) goto next_145;
    match_37 = 1;
    goto end_match_143;
next_145:;
    exit(1);
