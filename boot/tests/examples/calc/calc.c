...
int go_(struct CharStringTuple2 arg_, int i_);

int strContains_(char c_1, struct String s_);

struct StringStringTuple2;

int go_1(struct StringStringTuple2 arg_1, int i_1);
...
int go_5(struct StringIntTuple2 arg_2, int acc_2, int i_2);
...
int isDigit_(int arg_3, char c_3);

struct CharBoolFun1;

struct CharBoolFun1StringTuple2;

int go_7(struct CharBoolFun1StringTuple2 arg_5, int r_3);

int takeWhile_(struct CharBoolFun1 pred_, struct StringIntTuple2 arg_4);

struct CharTuple1;

int fun_(void* env_, char arg_12);

struct Token_ListIntTuple2;

struct Token_ListIntTuple2 readSpace_(struct String source_3, struct Token_ListIntTuple2 arg_6);

struct Token_ListIntTuple2 readEol_(struct String source_4, struct Token_ListIntTuple2 arg_7);

struct UnitTuple1;

int fun_1(void* env_2, char arg_13);

struct Token_ListIntTuple2 readInt_(struct String source_5, struct Token_ListIntTuple2 arg_8);

struct StringTuple1;

char at_(struct StringTuple1 arg_9, int i_7);

struct Token_List* go_8(struct StringTuple1 arg_10, struct Token_ListIntTuple2 arg_11);
...
int go_1(struct StringStringTuple2 arg_1, int i_1) {
    struct String prefix_ = arg_1.t0;
    struct String s_1 = arg_1.t1;
    int match_4;
...
int go_5(struct StringIntTuple2 arg_2, int acc_2, int i_2) {
    struct String source_ = arg_2.t0;
    int r_2 = arg_2.t1;
    int match_13;
...
int go_7(struct CharBoolFun1StringTuple2 arg_5, int r_3) {
    ...
    struct String source_2 = arg_5.t1;
    int match_15;
    int match_16;
...
end_match_65:;
    ...
    tuple_6.t0 = pred_;
    tuple_6.t1 = source_2;
    int call_20 = go_7(tuple_6, (r_3 + 1));
    match_15 = call_20;
    goto end_match_64;
next_68:;
...
int takeWhile_(struct CharBoolFun1 pred_, struct StringIntTuple2 arg_4) {
    struct String source_2 = arg_4.t0;
    int i_3 = arg_4.t1;
    struct CharBoolFun1StringTuple2 tuple_7;
    tuple_7.t0 = pred_;
    tuple_7.t1 = source_2;
    int call_21 = go_7(tuple_7, i_3);
    return call_21;
}
...
int fun_(void* env_, char arg_12) {
    int call_88 = charEq_((*(((struct CharTuple1*)env_))).t0, arg_12);
    return call_88;
}
...
struct Token_ListIntTuple2 readSpace_(struct String source_3, struct Token_ListIntTuple2 arg_6) {
    ...
    struct StringIntTuple2 tuple_8;
    tuple_8.t0 = source_3;
    tuple_8.t1 = (i_4 + 1);
    int call_24 = takeWhile_(call_23, tuple_8);
    int r_4 = call_24;
...
int fun_1(void* env_2, char arg_13) {
    int call_89 = isDigit_((*(((struct UnitTuple1*)env_2))).t0, arg_13);
    return call_89;
}

struct Token_ListIntTuple2 readInt_(struct String source_5, struct Token_ListIntTuple2 arg_8) {
    struct Token_List* acc_6 = arg_8.t0;
    int i_6 = arg_8.t1;
    ...
    struct StringIntTuple2 tuple_11;
    tuple_11.t0 = source_5;
    tuple_11.t1 = i_6;
    int call_29 = takeWhile_(call_28, tuple_11);
    int r_6 = call_29;
    ...
    list_2->tail = acc_6;
    struct Token_ListIntTuple2 tuple_12;
    tuple_12.t0 = list_2;
    tuple_12.t1 = r_6;
    return tuple_12;
}
...
char at_(struct StringTuple1 arg_9, int i_7) {
    struct String source_6 = arg_9.t0;
    char match_21;
...
struct Token_List* go_8(struct StringTuple1 arg_10, struct Token_ListIntTuple2 arg_11) {
    struct String source_6 = arg_10.t0;
    struct Token_List* acc_7 = arg_11.t0;
    int i_8 = arg_11.t1;
...
next_86:;
    ...
    tuple_13.t0 = source_6;
    struct Token_ListIntTuple2 tuple_14;
    tuple_14.t0 = acc_7;
    tuple_14.t1 = i_8;
    struct Token_ListIntTuple2 call_32 = readSpace_(source_6, tuple_14);
    struct Token_List* call_33 = go_8(tuple_13, call_32);
    match_23 = call_33;
    goto end_match_88;
next_89:;
    ...
    tuple_16.t0 = acc_7;
    tuple_16.t1 = i_8;
    struct Token_ListIntTuple2 call_34 = readEol_(source_6, tuple_16);
    struct Token_List* call_35 = go_8(tuple_15, call_34);
    match_23 = call_35;
    goto end_match_88;
next_90:;
    if (!((source_6.str[i_8] == '\n'))) goto next_91;
    ...
    tuple_18.t0 = acc_7;
    tuple_18.t1 = i_8;
    struct Token_ListIntTuple2 call_36 = readEol_(source_6, tuple_18);
    struct Token_List* call_37 = go_8(tuple_17, call_36);
    match_23 = call_37;
    goto end_match_88;
next_91:;
    ...
    if (!((call_38 == 1))) goto next_94;
    struct StringTuple1 tuple_19;
    tuple_19.t0 = source_6;
    struct Token_ListIntTuple2 tuple_20;
    tuple_20.t0 = acc_7;
    tuple_20.t1 = i_8;
    struct Token_ListIntTuple2 call_39 = readInt_(source_6, tuple_20);
    struct Token_List* call_40 = go_8(tuple_19, call_39);
    match_24 = call_40;
    goto end_match_93;
next_94:;
    if (!((call_38 == 0))) goto next_95;
    ...
    tuple_22.t0 = list_3;
    tuple_22.t1 = (i_8 + 1);
    struct Token_List* call_41 = go_8(tuple_21, tuple_22);
    match_24 = call_41;
    goto end_match_93;
next_95:;
    exit(1);
...
struct Token_List* tokenize_(struct String source_6) {
    ...
    tuple_24.t0 = NULL;
    tuple_24.t1 = 0;
    struct Token_List* call_42 = go_8(tuple_23, tuple_24);
    return call_42;
}
...
next_101:;
    ...
    struct IntToken_ListTuple2 call_47 = evalExpr_(tokens_6);
    int value_1 = call_47.t0;
    if (!((!((!(call_47.t1)))))) goto next_104;
    if (!((call_47.t1->head.tag == TkOp_))) goto next_104;
    if (!((call_47.t1->head.TkOp_ == ')'))) goto next_104;
    struct Token_List* tokens_7 = call_47.t1->tail;
    struct IntToken_ListTuple2 tuple_26;
    tuple_26.t0 = value_1;
    tuple_26.t1 = tokens_7;
    match_27 = tuple_26;
    goto end_match_103;
next_104:;
    printf("expected ')'\n");
...
struct IntToken_ListTuple2 go_9(int acc_8, struct Token_List* tokens_9) {
    ...
    struct IntToken_ListTuple2 call_50 = evalTerm_(tokens_10);
    int r_7 = call_50.t0;
    struct Token_List* tokens_11 = call_50.t1;
    struct IntToken_ListTuple2 call_51 = go_9((acc_8 * r_7), tokens_11);
    match_28 = call_51;
    goto end_match_107;
next_108:;
    struct IntToken_ListTuple2 tuple_27;
    tuple_27.t0 = acc_8;
    tuple_27.t1 = tokens_9;
    match_28 = tuple_27;
    goto end_match_107;
next_109:;
end_match_107:;
...
struct IntToken_ListTuple2 evalMul_(struct Token_List* tokens_8) {
    struct IntToken_ListTuple2 call_52 = evalTerm_(tokens_8);
    int l_3 = call_52.t0;
    struct Token_List* tokens_12 = call_52.t1;
    struct IntToken_ListTuple2 call_53 = go_9(l_3, tokens_12);
    return call_53;
}
...
struct IntToken_ListTuple2 go_10(int acc_9, struct Token_List* tokens_14) {
    ...
    struct IntToken_ListTuple2 call_55 = go_10((acc_9 + r_8), tokens_16);
    match_29 = call_55;
    goto end_match_110;
next_111:;
    ...
    struct IntToken_ListTuple2 call_56 = evalMul_(tokens_17);
    int r_9 = call_56.t0;
    struct Token_List* tokens_18 = call_56.t1;
    struct IntToken_ListTuple2 call_57 = go_10((acc_9 - r_9), tokens_18);
    match_29 = call_57;
    goto end_match_110;
next_112:;
    struct IntToken_ListTuple2 tuple_28;
    tuple_28.t0 = acc_9;
    tuple_28.t1 = tokens_14;
    match_29 = tuple_28;
    goto end_match_110;
next_113:;
end_match_110:;
...
struct IntToken_ListTuple2 evalAdd_(struct Token_List* tokens_13) {
    struct IntToken_ListTuple2 call_58 = evalMul_(tokens_13);
    int l_4 = call_58.t0;
    struct Token_List* tokens_19 = call_58.t1;
    struct IntToken_ListTuple2 call_59 = go_10(l_4, tokens_19);
    return call_59;
}

struct IntToken_ListTuple2 evalExpr_(struct Token_List* tokens_3) {
    struct IntToken_ListTuple2 call_60 = evalAdd_(tokens_3);
    return call_60;
}

int eval_(struct String str_) {
    int match_30;
    struct Token_List* call_61 = tokenize_(str_);
    struct IntToken_ListTuple2 call_62 = evalExpr_(call_61);
    int value_2 = call_62.t0;
    if (!((!(call_62.t1)))) goto next_115;
    match_30 = value_2;
    goto end_match_114;
next_115:;
    struct Token_List* tokens_20 = call_62.t1;
    printf("ERROR: couldn't parse tokens:\n");
    int call_63 = 0;
    int call_64 = tokenListPrint_(tokens_20);
    exit(1);
    match_30 = 0;
    goto end_match_114;
next_116:;
...
int main() {
    int call_65 = strContains_('+', (struct String){.str = "+-*/", .len = 4});
    int call_66 = assert_(call_65);
    int call_67 = strStartsWith_((struct String){.str = "hell", .len = 4}, (struct String){.str = "hello", .len = 5});
    int call_68 = assert_(call_67);
    int call_69 = strStartsWith_((struct String){.str = "heaven", .len = 6}, (struct String){.str = "hello", .len = 5});
    int call_70 = assert_((!(call_69)));
    ...
    list_4->tail = list_5;
    struct String call_71 = strConcat_(list_4);
    int call_72 = assert_((str_cmp(call_71, (struct String){.str = "a,b", .len = 3}) == 0));
    ...
    list_7->tail = list_8;
    struct StringList* call_73 = strListRev_(list_7);
    struct String call_74 = strConcat_(call_73);
    int call_75 = assert_((str_cmp(call_74, (struct String){.str = "b,a", .len = 3}) == 0));
    struct String call_76 = intToString_(1024);
    int call_77 = assert_((str_cmp(call_76, (struct String){.str = "1024", .len = 4}) == 0));
    int call_78 = intParse_((struct String){.str = "1024", .len = 4});
    int call_79 = assert_((call_78 == 1024));
    struct String source_7 = (struct String){.str = "2 + 3\r\n    - 4", .len = 14};
    struct Token_List* call_80 = tokenize_(source_7);
    int call_81 = tokenListPrint_(call_80);
    int call_82 = eval_(source_7);
    int call_83 = assert_((call_82 == ((2 + 3) - 4)));
    int call_84 = eval_((struct String){.str = "2 - 3 * 4 + 5", .len = 13});
    int call_85 = assert_((call_84 == ((2 - (3 * 4)) + 5)));
    int call_86 = eval_((struct String){.str = "(2 - 3) * 4 + (1 + (2 + 2))", .len = 27});
    int call_87 = assert_((call_86 == (((2 - 3) * 4) + (1 + (2 + 2)))));
    return 0;
}
