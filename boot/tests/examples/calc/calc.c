...
int go_5(struct CharBoolFun1StringTuple2 arg_5, int r_2);
...
next_20:;
    ...
    struct String call_6 = go_2(xs_2);
    match_6 = str_add(x_, call_6);
    goto end_match_19;
next_21:;
    exit(1);
end_match_19:;
...
next_23:;
    ...
    list_->head = x_1;
    list_->tail = acc_;
    struct StringList* call_8 = go_3(list_, xs_5);
    match_7 = call_8;
    goto end_match_22;
next_24:;
    exit(1);
...
struct StringList* strListRev_(struct StringList* xs_3) {
    struct StringList* call_9 = go_3(NULL, xs_3);
    return call_9;
}
...
next_26:;
    ...
    list_1->head = x_2;
    list_1->tail = acc_1;
    struct Token_List* call_10 = go_4(list_1, xs_8);
    match_8 = call_10;
    goto end_match_25;
next_27:;
    exit(1);
...
struct Token_List* tokenListRev_(struct Token_List* xs_6) {
    struct Token_List* call_11 = go_4(NULL, xs_6);
    return call_11;
}
...
int go_5(struct CharBoolFun1StringTuple2 arg_5, int r_2) {
    ...
    int match_10;
    int match_11;
    if (!(((r_2 < source_.len) == 1))) goto next_33;
    int app_ = pred_.fun(pred_.env, source_.str[r_2]);
    match_11 = app_;
    goto end_match_32;
next_33:;
    if (!(((r_2 < source_.len) == 0))) goto next_34;
    match_11 = 0;
    goto end_match_32;
next_34:;
    exit(1);
end_match_32:;
    ...
    tuple_4.t0 = pred_;
    tuple_4.t1 = source_;
    int call_12 = go_5(tuple_4, (r_2 + 1));
    match_10 = call_12;
    goto end_match_31;
next_35:;
...
struct Token_ListIntTuple2 readSpace_(struct String source_1, struct Token_ListIntTuple2 arg_7) {
    ...
    int i_3 = arg_7.t1;
    int call_15 = assert_((source_1.str[i_3] == ' '));
    ...
    tuple_7.t0 = source_1;
    tuple_7.t1 = (i_3 + 1);
    int call_16 = takeWhile_(fun_2, tuple_7);
    int r_3 = call_16;
...
struct Token_ListIntTuple2 readInt_(struct String source_3, struct Token_ListIntTuple2 arg_9) {
    ...
    int i_5 = arg_9.t1;
    int call_19 = isDigit_(source_3.str[i_5]);
    int call_20 = assert_(call_19);
    ...
    tuple_10.t1 = i_5;
    int call_21 = takeWhile_(fun_3, tuple_10);
    int r_5 = call_21;
    struct String call_22 = strSlice_(i_5, r_5, source_3);
    int call_23 = str_to_int(call_22);
    int n_ = call_23;
...
struct Token_List* go_6(struct StringTuple1 arg_11, struct Token_ListIntTuple2 arg_12) {
    ...
    struct Token_List* call_24 = tokenListRev_(acc_5);
    match_17 = call_24;
    goto end_match_52;
next_53:;
    ...
    tuple_13.t0 = acc_5;
    tuple_13.t1 = i_7;
    struct Token_ListIntTuple2 call_25 = readSpace_(source_4, tuple_13);
    struct Token_List* call_26 = go_6(tuple_12, call_25);
    match_18 = call_26;
    goto end_match_55;
next_56:;
    ...
    tuple_15.t0 = acc_5;
    tuple_15.t1 = i_7;
    struct Token_ListIntTuple2 call_27 = readEol_(source_4, tuple_15);
    struct Token_List* call_28 = go_6(tuple_14, call_27);
    match_18 = call_28;
    goto end_match_55;
next_57:;
    if (!((source_4.str[i_7] == '\n'))) goto next_58;
    ...
    tuple_17.t0 = acc_5;
    tuple_17.t1 = i_7;
    struct Token_ListIntTuple2 call_29 = readEol_(source_4, tuple_17);
    struct Token_List* call_30 = go_6(tuple_16, call_29);
    match_18 = call_30;
    goto end_match_55;
next_58:;
    char c_2 = source_4.str[i_7];
    struct Token_List* match_19;
    int call_31 = isDigit_(c_2);
    if (!((call_31 == 1))) goto next_61;
    struct StringTuple1 tuple_18;
    tuple_18.t0 = source_4;
    struct Token_ListIntTuple2 tuple_19;
    tuple_19.t0 = acc_5;
    tuple_19.t1 = i_7;
    struct Token_ListIntTuple2 call_32 = readInt_(source_4, tuple_19);
    struct Token_List* call_33 = go_6(tuple_18, call_32);
    match_19 = call_33;
    goto end_match_60;
next_61:;
    if (!((call_31 == 0))) goto next_62;
    ...
    tuple_21.t0 = list_3;
    tuple_21.t1 = (i_7 + 1);
    struct Token_List* call_34 = go_6(tuple_20, tuple_21);
    match_19 = call_34;
    goto end_match_60;
next_62:;
    exit(1);
...
struct Token_List* tokenize_(struct String source_4) {
    ...
    tuple_23.t0 = NULL;
    tuple_23.t1 = 0;
    struct Token_List* call_35 = go_6(tuple_22, tuple_23);
    return call_35;
}
...
next_64:;
    ...
    printf("int %d\n", n_1);
    int call_36 = 0;
    int call_37 = tokenListPrint_(tokens_1);
    match_20 = 0;
    goto end_match_63;
next_65:;
    ...
    printf("op %c\n", c_3);
    int call_38 = 0;
    int call_39 = tokenListPrint_(tokens_2);
    match_20 = 0;
    goto end_match_63;
next_66:;
    exit(1);
...
next_68:;
    ...
    struct IntToken_ListTuple2 call_40 = evalExpr_(tokens_6);
    int value_ = call_40.t0;
    if (!((!((!(call_40.t1)))))) goto next_72;
    if (!((call_40.t1->head.tag == TkOp_))) goto next_72;
    if (!(((*(call_40.t1->head.TkOp_)) == ')'))) goto next_72;
    struct Token_List* tokens_7 = call_40.t1->tail;
...
struct IntToken_ListTuple2 go_7(int acc_6, struct Token_List* tokens_9) {
    ...
    struct IntToken_ListTuple2 call_43 = evalTerm_(tokens_10);
    int r_6 = call_43.t0;
    struct Token_List* tokens_11 = call_43.t1;
    struct IntToken_ListTuple2 call_44 = go_7((acc_6 * r_6), tokens_11);
    match_23 = call_44;
    goto end_match_74;
next_75:;
...
struct IntToken_ListTuple2 evalMul_(struct Token_List* tokens_8) {
    struct IntToken_ListTuple2 call_45 = evalTerm_(tokens_8);
    int l_2 = call_45.t0;
    struct Token_List* tokens_12 = call_45.t1;
    struct IntToken_ListTuple2 call_46 = go_7(l_2, tokens_12);
    return call_46;
}
...
struct IntToken_ListTuple2 go_8(int acc_7, struct Token_List* tokens_14) {
    ...
    struct IntToken_ListTuple2 call_47 = evalMul_(tokens_15);
    int r_7 = call_47.t0;
    struct Token_List* tokens_16 = call_47.t1;
    struct IntToken_ListTuple2 call_48 = go_8((acc_7 + r_7), tokens_16);
    match_24 = call_48;
    goto end_match_77;
next_78:;
    ...
    struct IntToken_ListTuple2 call_49 = evalMul_(tokens_17);
    int r_8 = call_49.t0;
    struct Token_List* tokens_18 = call_49.t1;
    struct IntToken_ListTuple2 call_50 = go_8((acc_7 - r_8), tokens_18);
    match_24 = call_50;
    goto end_match_77;
next_79:;
...
struct IntToken_ListTuple2 evalAdd_(struct Token_List* tokens_13) {
    struct IntToken_ListTuple2 call_51 = evalMul_(tokens_13);
    int l_3 = call_51.t0;
    struct Token_List* tokens_19 = call_51.t1;
    struct IntToken_ListTuple2 call_52 = go_8(l_3, tokens_19);
    return call_52;
}

struct IntToken_ListTuple2 evalExpr_(struct Token_List* tokens_3) {
    struct IntToken_ListTuple2 call_53 = evalAdd_(tokens_3);
    return call_53;
}

int eval_(struct String str_) {
    int match_25;
    struct Token_List* call_54 = tokenize_(str_);
    struct IntToken_ListTuple2 call_55 = evalExpr_(call_54);
    int value_1 = call_55.t0;
    if (!((!(call_55.t1)))) goto next_82;
    match_25 = value_1;
    goto end_match_81;
next_82:;
    struct Token_List* tokens_20 = call_55.t1;
    printf("ERROR: couldn't parse tokens:\n");
    int call_56 = 0;
    int call_57 = tokenListPrint_(tokens_20);
    exit(1);
    match_25 = 0;
    goto end_match_81;
next_83:;
...
int main() {
    int call_58 = strContains_('+', (struct String){.str = "+-*/", .len = 4});
    int call_59 = assert_(call_58);
    int call_60 = strStartsWith_((struct String){.str = "hell", .len = 4}, (struct String){.str = "hello", .len = 5});
    int call_61 = assert_(call_60);
    int call_62 = strStartsWith_((struct String){.str = "heaven", .len = 6}, (struct String){.str = "hello", .len = 5});
    int call_63 = assert_((!(call_62)));
    ...
    list_4->tail = list_5;
    struct String call_64 = strConcat_(list_4);
    int call_65 = assert_((str_cmp(call_64, (struct String){.str = "a,b", .len = 3}) == 0));
    ...
    list_7->tail = list_8;
    struct StringList* call_66 = strListRev_(list_7);
    struct String call_67 = strConcat_(call_66);
    int call_68 = assert_((str_cmp(call_67, (struct String){.str = "b,a", .len = 3}) == 0));
    struct String source_5 = (struct String){.str = "2 + 3\r\n    - 4", .len = 14};
    struct Token_List* call_69 = tokenize_(source_5);
    int call_70 = tokenListPrint_(call_69);
    int call_71 = eval_(source_5);
    int call_72 = assert_((call_71 == ((2 + 3) - 4)));
    int call_73 = eval_((struct String){.str = "2 - 3 * 4 + 5", .len = 13});
    int call_74 = assert_((call_73 == ((2 - (3 * 4)) + 5)));
    int call_75 = eval_((struct String){.str = "(2 - 3) * 4 + (1 + (2 + 2))", .len = 27});
    int call_76 = assert_((call_75 == (((2 - 3) * 4) + (1 + (2 + 2)))));
    return 0;
}
