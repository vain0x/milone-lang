...
end_match_23:;
    ...
    struct String call_8 = str_substring(i_1, i_1, s_);
    ...
    tuple_2.t0 = s_;
    struct StringList* call_9 = go_1(tuple_2, acc_2, (i_1 + 1));
    match_7 = call_9;
    goto end_match_22;
next_29:;
    ...
    if (!((call_10 == 1))) goto next_32;
    struct StringTuple1 tuple_3;
    tuple_3.t0 = s_;
    int call_11 = readInt_(tuple_3, i_1);
    int r_ = call_11;
    struct String call_12 = str_substring(i_1, (r_ - 1), s_);
    ...
    tuple_4.t0 = s_;
    struct StringList* call_13 = go_1(tuple_4, acc_3, r_);
    match_10 = call_13;
    goto end_match_31;
next_32:;
    if (!((call_10 == 0))) goto next_33;
...
struct StringList* tokenize_(struct String s_) {
    ...
    tuple_5.t0 = s_;
    struct StringList* call_15 = go_1(tuple_5, NULL, 0);
    return call_15;
}
