...
int main() {
    int call_5 = abs_(0);
    milone_assert((call_5 == 0));
    int call_6 = 0;
    int call_7 = abs_(1);
    milone_assert((call_7 == 1));
    int call_8 = 0;
    int call_9 = neg_(1);
    ...
    milone_assert((call_12 == 1));
    int call_13 = 0;
    int call_14 = gcd_(12, 18);
    milone_assert((call_14 == 6));
    int call_15 = 0;
    int call_16 = neg_(6);
    int call_17 = gcd_(4, call_16);
    milone_assert((call_17 == 2));
    int call_18 = 0;
    int call_19 = isPrime_(2);
    milone_assert(call_19);
    int call_20 = 0;
    int call_21 = isPrime_(3);
    milone_assert(call_21);
    int call_22 = 0;
    int call_23 = isPrime_(4);
    milone_assert((!(call_23)));
    int call_24 = 0;
    int call_25 = isPrime_(1000000007);
    milone_assert(call_25);
    int call_26 = 0;
    return 0;
}
