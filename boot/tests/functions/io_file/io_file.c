...
int main() {
    struct String call_2 = fileReadAllText_((struct String){.str = "boot/tests/functions/io_file/input.txt", .len = 38});
    ...
    int call_4 = fileWriteAllText_((struct String){.str = "boot/tests/functions/io_file/output.txt", .len = 39}, content_2);
    return 0;
}
