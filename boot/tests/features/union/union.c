...
next_2:;
    ...
    milone_assert((str_cmp(e_, (struct String){.str = "No such file or directory.", .len = 26}) == 0));
    int call_1 = 0;
    match_ = 0;
    goto end_match_1;
next_3:;
...
end_match_7:;
    ...
    int match_4;
    if (!(((statusCode_ == 404) == 1))) goto next_14;
    match_4 = (str_cmp(statusText_, (struct String){.str = "Not Found", .len = 9}) == 0);
    goto end_match_13;
next_14:;
    if (!(((statusCode_ == 404) == 0))) goto next_15;
    match_4 = 0;
    goto end_match_13;
next_15:;
    exit(1);
end_match_13:;
    milone_assert(match_4);
    int call_4 = 0;
    match_3 = 0;
    goto end_match_10;
next_11:;
