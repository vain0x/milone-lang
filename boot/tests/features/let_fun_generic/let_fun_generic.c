...
end_match_18:;
    ...
    struct StringIntTuple2List* call_19 = listMap_1(fun_5, list_12);
    if ((!(call_19))) goto next_22;
    if ((str_cmp(call_19->head.t0, (struct String){.str = "a", .len = 1}) != 0)) goto next_22;
    if ((call_19->head.t1 != 1)) goto next_22;
    if ((!(call_19->tail))) goto next_22;
    if ((str_cmp(call_19->tail->head.t0, (struct String){.str = "b", .len = 1}) != 0)) goto next_22;
    if ((call_19->tail->head.t1 != 2)) goto next_22;
    if ((!((!(call_19->tail->tail))))) goto next_22;
    match_6 = 0;
    goto end_match_21;
next_22:;
