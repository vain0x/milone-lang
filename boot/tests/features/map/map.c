...
struct IntIntStringTuple2ListTuple2ListIntIntFun1IntIntIntFun2Tuple3 mapNewSingleton_2(int key_, struct String value_, struct IntIntFun1 hash_, struct IntIntIntFun2 cmp_) {
    ...
    tuple_1.t0 = app_1;
    tuple_1.t1 = list_1;
    struct IntIntStringTuple2ListTuple2List* list_ = (struct IntIntStringTuple2ListTuple2List*)milone_mem_alloc(1, sizeof(struct IntIntStringTuple2ListTuple2List));
    list_->head = tuple_1;
    list_->tail = NULL;
...
struct IntIntUnitTuple2ListTuple2ListIntIntFun1IntIntIntFun2Tuple3 mapNewSingleton_1(int key_, int value_, struct IntIntFun1 hash_, struct IntIntIntFun2 cmp_) {
    ...
    tuple_4.t0 = app_3;
    tuple_4.t1 = list_3;
    struct IntIntUnitTuple2ListTuple2List* list_2 = (struct IntIntUnitTuple2ListTuple2List*)milone_mem_alloc(1, sizeof(struct IntIntUnitTuple2ListTuple2List));
    list_2->head = tuple_4;
    list_2->tail = NULL;
