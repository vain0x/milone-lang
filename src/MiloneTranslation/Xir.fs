...
type XTy =
  ...
  // FFI types.
  | XVoidPtrTy of IsMut
  | XNativePtrTy of RefMode * XNativePtrTyId
...
module XTy =
  let toOrder ty =
    ...
    | XNativePtrTy(RefMode.ReadWrite, nativePtrTyId) -> ofPair 23 nativePtrTyId
    | XNativePtrTy(RefMode.ReadOnly, nativePtrTyId) -> ofPair 27 nativePtrTyId // ordering
    | XNativePtrTy(RefMode.WriteOnly, nativePtrTyId) -> ofPair 28 nativePtrTyId
