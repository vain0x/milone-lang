...
int main() {
    ...
    list_1->tail = list_2;
    void* box_ = (void*)milone_mem_alloc(1, sizeof(struct Node_List*));
    (*(((struct Node_List**)box_))) = list_1;
    struct Node_ variant_2 = (struct Node_){.tag = Node_, .Node_ = box_};
    void* box_1 = (void*)milone_mem_alloc(1, sizeof(struct Node_List*));
...
end_match_1:;
    ...
    void* box_5 = (void*)milone_mem_alloc(1, sizeof(struct First_Second_Tuple2ListFirst_ListSecond_ListTuple2Fun1));
    ...
    void* box_7 = (void*)milone_mem_alloc(1, sizeof(struct First_Second_Tuple2ListFirst_ListSecond_ListTuple2Fun1));
