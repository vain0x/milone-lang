...
int main() {
    ...
    if (((*(((struct Node_List const* const*)variant_6.Node_)))->head.tag != Node_)) goto next_2;
    if ((!((*(((struct Node_List const* const*)(*(((struct Node_List const* const*)variant_6.Node_)))->head.Node_)))))) goto next_2;
    if (((*(((struct Node_List const* const*)(*(((struct Node_List const* const*)variant_6.Node_)))->head.Node_)))->head.tag != Leaf_)) goto next_2;
    ...
    if (((*(((struct Node_List const* const*)(*(((struct Node_List const* const*)variant_6.Node_)))->head.Node_)))->tail->head.tag != Leaf_)) goto next_2;
    ...
    if (((*(((struct Node_List const* const*)variant_6.Node_)))->tail->head.tag != Node_)) goto next_2;
    ...
    if (((*(((struct Node_List const* const*)variant_6.Node_)))->tail->tail->head.tag != Node_)) goto next_2;
    if ((!((*(((struct Node_List const* const*)(*(((struct Node_List const* const*)variant_6.Node_)))->tail->tail->head.Node_)))))) goto next_2;
    if (((*(((struct Node_List const* const*)(*(((struct Node_List const* const*)variant_6.Node_)))->tail->tail->head.Node_)))->head.tag != Leaf_)) goto next_2;
