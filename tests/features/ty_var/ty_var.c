...
int main() {
    struct IntIntTuple2 tuple_1 = (struct IntIntTuple2){.t0 = 0, .t1 = 0};
    int call_1 = pair_2(tuple_1);
    milone_assert((call_1 == 2), 14, 2);
    struct StringStringTuple2 tuple_2 = (struct StringStringTuple2){.t0 = (struct String){.str = "", .len = 0}, .t1 = (struct String){.str = "", .len = 0}};
