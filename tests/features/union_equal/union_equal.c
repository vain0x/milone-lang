...
bool union_equal_union_equal_MyValueEqual(struct MyValue_ l_6, struct MyValue_ r_6);
...
bool union_equal_union_equal_MyResultEqual(struct MyResult_ l_3, struct MyResult_ r_3) {
    ...
    bool call_ = union_equal_union_equal_MyValueEqual(l_4, r_4);
    match_3 = call_;
    goto end_match_14;
next_15:;
...
void union_equal_union_equal_testMyBool(void) {
    ...
    bool call_1 = union_equal_union_equal_MyBoolEqual(t_, (struct MyBool_){.discriminant = MyTrue_});
    milone_assert(call_1, 9, 2);
    bool call_2 = union_equal_union_equal_MyBoolEqual(t_, (struct MyBool_){.discriminant = MyFalse_});
    milone_assert((!(call_2)), 10, 2);
    struct MyBool_ f_ = (struct MyBool_){.discriminant = MyFalse_};
    bool call_3 = union_equal_union_equal_MyBoolEqual(t_, f_);
    milone_assert((!(call_3)), 13, 2);
    bool call_4 = union_equal_union_equal_MyBoolEqual(f_, (struct MyBool_){.discriminant = MyFalse_});
...
void union_equal_union_equal_testMyInt(void) {
    ...
    bool call_5 = union_equal_union_equal_MyIntOptionEqual(s_, variant_1);
    milone_assert(call_5, 23, 2);
    struct MyIntOption_ variant_2 = (struct MyIntOption_){.discriminant = MySome_, .MySome_ = 3};
    bool call_6 = union_equal_union_equal_MyIntOptionEqual(s_, variant_2);
    milone_assert((!(call_6)), 24, 2);
    bool call_7 = union_equal_union_equal_MyIntOptionEqual(s_, (struct MyIntOption_){.discriminant = MyNone_});
    milone_assert((!(call_7)), 25, 2);
    struct MyIntOption_ n_ = (struct MyIntOption_){.discriminant = MyNone_};
    bool call_8 = union_equal_union_equal_MyIntOptionEqual(s_, n_);
    milone_assert((!(call_8)), 28, 2);
    bool call_9 = union_equal_union_equal_MyIntOptionEqual(n_, (struct MyIntOption_){.discriminant = MyNone_});
...
void union_equal_union_equal_testMyResult(void) {
    ...
    bool call_10 = union_equal_union_equal_MyResultEqual(ok2_, variant_6);
    ...
    bool call_11 = union_equal_union_equal_MyResultEqual(ok2_, variant_8);
    ...
    bool call_12 = union_equal_union_equal_MyResultEqual(ok2_, variant_9);
    ...
    bool call_13 = union_equal_union_equal_MyResultEqual(ok2_, variant_10);
    ...
    bool call_14 = union_equal_union_equal_MyResultEqual(hello_, variant_14);
    milone_assert(call_14, 49, 2);
    bool call_15 = union_equal_union_equal_MyResultEqual(hello_, ok2_);
    ...
    bool call_16 = union_equal_union_equal_MyResultEqual(hello_, variant_15);
