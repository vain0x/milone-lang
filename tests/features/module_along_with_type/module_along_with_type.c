...
struct IntIntTuple2 add_(struct IntIntTuple2 l_, struct IntIntTuple2 r_1);

struct String toString_1(struct IntIntTuple2 arg_);
...
struct String toString_(struct IntIntTuple2IntIntTuple2Tuple2 arg_1);
...
int milone_main() {
    ...
    struct IntIntTuple2IntIntTuple2Tuple2 r_ = tuple_3;
