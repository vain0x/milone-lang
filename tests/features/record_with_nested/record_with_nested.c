...
struct Person_ record_with_nested_record_with_nested_newPerson(void) {
    ...
    Person_ = (struct Person_){.t0 = (struct String){.str = "Jane Doe", .len = 8}, .t1 = 16, .t2 = Date_};
    return Person_;
}
...
int main(int argc, char** argv) {
    ...
    base_ = call_;
    Person_1 = (struct Person_){.t0 = (struct String){.str = "John Doe", .len = 8}, .t1 = base_.t1, .t2 = base_.t2};
    john_ = Person_1;
    name_ = john_.t0;
