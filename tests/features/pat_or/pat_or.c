...
void pat_or_pat_or_simpleCase(void) {
    bool call_ = pat_or_pat_or_isZeroOrOne(0);
    bool if_;
    if (call_) {
        goto then_5;
    } else {
...
then_5:;
    bool call_1 = pat_or_pat_or_isZeroOrOne(1);
    if_ = call_1;
    goto if_next_4;
else_6:;
    if_ = false;
...
if_next_4:;
    ...
    bool call_2 = pat_or_pat_or_isZeroOrOne(2);
...
void pat_or_pat_or_nestedCase(void) {
    ...
    bool call_3 = pat_or_pat_or_startsWithDoubleBits(list_);
    ...
    bool call_4 = pat_or_pat_or_startsWithDoubleBits(list_3);
...
void pat_or_pat_or_complexCase(void) {
    ...
    bool call_5 = pat_or_pat_or_performComplexMatching(IntIntTuple2_);
    ...
    bool call_6 = pat_or_pat_or_performComplexMatching(IntIntTuple2_1);
