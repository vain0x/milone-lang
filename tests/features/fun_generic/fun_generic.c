...
next_2:;
    ...
    list_ = ((struct StringIntTuple2_List const*)milone_mem_alloc(1, sizeof(struct StringIntTuple2_List)));
...
int main(int argc, char** argv) {
    ...
    IntStringTuple2_1 = (struct IntStringTuple2_){.t0 = 1, .t1 = (struct String){.str = "a", .len = 1}};
...
end_match_15:;
    ...
    list_11 = ((struct StringList const*)milone_mem_alloc(1, sizeof(struct StringList)));
    (*(((struct StringList*)list_11))) = (struct StringList){.head = (struct String){.str = "b", .len = 1}, .tail = NULL};
    list_10 = ((struct StringList const*)milone_mem_alloc(1, sizeof(struct StringList)));
...
end_match_18:;
    ...
    list_13 = ((struct IntStringTuple2_List const*)milone_mem_alloc(1, sizeof(struct IntStringTuple2_List)));
    (*(((struct IntStringTuple2_List*)list_13))) = (struct IntStringTuple2_List){.head = IntStringTuple2_3, .tail = NULL};
    list_12 = ((struct IntStringTuple2_List const*)milone_mem_alloc(1, sizeof(struct IntStringTuple2_List)));
