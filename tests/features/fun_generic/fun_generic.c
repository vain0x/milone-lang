...
next_2:;
    ...
    x_1 = xs_3->head;
    xs_4 = xs_3->tail;
    struct StringIntTuple2_ app_ = f_.fun(f_.env, x_1);
    struct StringIntTuple2_List const* call_ = fun_generic_fun_generic_IntStringTuple2StringIntTuple2Fun1IntStringTuple2ListStringIntTuple2ListFun2_listMap(f_, xs_4);
...
next_5:;
    ...
    x_1 = xs_3->head;
    xs_4 = xs_3->tail;
    int app_1 = f_.fun(f_.env, x_1);
    struct IntList const* call_3 = fun_generic_fun_generic_IntIntFun1IntListIntListFun2_listMap(f_, xs_4);
...
int fun_generic_fun_generic_eta2_main_f(void const* env_, int arg_) {
    int call_4 = fun_generic_fun_generic_f(arg_);
    return call_4;
}

int fun_generic_fun_generic_eta2_main_f_1(void const* env_1, int arg_1) {
    int call_5 = fun_generic_fun_generic_f(arg_1);
    return call_5;
}

struct StringIntTuple2_ fun_generic_fun_generic_eta2_main_flip(void const* env_2, struct IntStringTuple2_ arg_2) {
    struct StringIntTuple2_ call_6 = fun_generic_fun_generic_IntStringTuple2StringIntTuple2Fun1_flip(arg_2);
    return call_6;
}

int main(int argc, char** argv) {
    milone_start(argc, argv);
    int call_7 = fun_generic_fun_generic_IntIntFun1_id(42);
    int call_8 = fun_generic_fun_generic_IntIntFun1_id(1);
    ...
    struct StringList const* call_9 = fun_generic_fun_generic_StringListStringListFun1_id(list_4);
    ...
    struct IntList const* call_10 = fun_generic_fun_generic_IntIntFun1IntListIntListFun2_listMap(fun_1, list_5);
    struct IntList const* call_11 = fun_generic_fun_generic_IntIntFun1IntListIntListFun2_listMap(fun_, call_10);
    char match_4;
    struct IntStringTuple2_ IntStringTuple2_1 = (struct IntStringTuple2_){.t0 = 1, .t1 = (struct String){.str = "a", .len = 1}};
    struct StringIntTuple2_ call_12 = fun_generic_fun_generic_IntStringTuple2StringIntTuple2Fun1_flip(IntStringTuple2_1);
    struct IntStringTuple2_ call_13 = fun_generic_fun_generic_StringIntTuple2IntStringTuple2Fun1_flip(call_12);
...
end_match_18:;
    ...
    struct StringIntTuple2_List const* call_16 = fun_generic_fun_generic_IntStringTuple2StringIntTuple2Fun1IntStringTuple2ListStringIntTuple2ListFun2_listMap(fun_2, list_12);
