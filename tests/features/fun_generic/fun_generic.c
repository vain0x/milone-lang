...
struct StringInt32Tuple2_List const* fun_generic_fun_generic_Int32StringTuple2StringInt32Tuple2Fun1Int32StringTuple2ListStringInt32Tuple2ListFun2_listMap(struct Int32StringTuple2_StringInt32Tuple2_Fun1 f_, struct Int32StringTuple2_List const* xs_3);

struct StringList const* fun_generic_fun_generic_StringListStringListFun1_listRev(struct StringList const* xs_);

struct Int32List const* fun_generic_fun_generic_Int32ListInt32ListFun1_listRev(struct Int32List const* xs_);
...
struct Int32List const* fun_generic_fun_generic_Int32Int32Fun1Int32ListInt32ListFun2_listMap(struct Int32Int32Fun1 f_, struct Int32List const* xs_3);
...
struct Int32List const* fun_generic_fun_generic_listRev_Int32ListInt32ListInt32ListFun2_go(struct Int32List const* acc_, struct Int32List const* xs_1);
...
struct StringInt32Tuple2_List {
    ...
    struct StringInt32Tuple2_List const* tail;
};
...
struct Int32ListStringListTuple2_ {
    struct Int32List const* t0;
    struct StringList const* t1;
};

struct StringInt32Tuple2_List const* fun_generic_fun_generic_Int32StringTuple2StringInt32Tuple2Fun1Int32StringTuple2ListStringInt32Tuple2ListFun2_listMap(struct Int32StringTuple2_StringInt32Tuple2_Fun1 f_, struct Int32StringTuple2_List const* xs_3) {
    struct Int32StringTuple2_ x_1;
    struct Int32StringTuple2_List const* xs_4;
    struct StringInt32Tuple2_List const* match_;
    struct StringInt32Tuple2_List const* list_;
    struct StringInt32Tuple2_ app_;
    struct StringInt32Tuple2_List const* call_;
    if ((!((!(xs_3))))) goto next_2;
    match_ = NULL;
    goto end_match_1;
next_2:;
    ...
    list_ = ((struct StringInt32Tuple2_List const*)milone_region_alloc(1, sizeof(struct StringInt32Tuple2_List)));
    (*(((struct StringInt32Tuple2_List*)list_))) = (struct StringInt32Tuple2_List){.head = app_, .tail = call_};
    match_ = list_;
    goto end_match_1;
next_3:;
    exit(1);
...
struct Int32List const* fun_generic_fun_generic_Int32Int32Fun1Int32ListInt32ListFun2_listMap(struct Int32Int32Fun1 f_, struct Int32List const* xs_3) {
    int32_t x_1;
    struct Int32List const* xs_4;
    struct Int32List const* match_1;
    struct Int32List const* list_1;
    int32_t app_1;
    struct Int32List const* call_3;
    if ((!((!(xs_3))))) goto next_5;
    match_1 = NULL;
    goto end_match_4;
next_5:;
    ...
    (*(((struct Int32List*)list_1))) = (struct Int32List){.head = app_1, .tail = call_3};
    match_1 = list_1;
    goto end_match_4;
next_6:;
    exit(1);
...
struct Int32List const* fun_generic_fun_generic_listRev_Int32ListInt32ListInt32ListFun2_go(struct Int32List const* acc_, struct Int32List const* xs_1) {
    int32_t x_;
    struct Int32List const* xs_2;
    struct Int32List const* match_2;
    struct Int32List const* list_2;
    struct Int32List const* arg_5;
    struct Int32List const* arg_6;
tailrec_7:;
    if ((!((!(xs_1))))) goto next_9;
    match_2 = acc_;
    goto end_match_8;
next_9:;
    ...
    (*(((struct Int32List*)list_2))) = (struct Int32List){.head = x_, .tail = acc_};
    arg_5 = list_2;
    arg_6 = xs_2;
    acc_ = arg_5;
    xs_1 = arg_6;
...
int main(int argc, char** argv) {
    ...
    struct Int32List const* call_10;
    struct Int32List const* call_11;
    char match_4;
    ...
    struct Int32List const* call_14;
    ...
    struct Int32StringTuple2_List const* list_12;
    struct Int32StringTuple2_ Int32StringTuple2_2;
    struct Int32StringTuple2_List const* list_13;
    struct Int32StringTuple2_ Int32StringTuple2_3;
    struct StringInt32Tuple2_List const* call_16;
    ...
    (*(((struct Int32List*)list_7))) = (struct Int32List){.head = 3, .tail = NULL};
    list_6 = ((struct Int32List const*)milone_region_alloc(1, sizeof(struct Int32List)));
    (*(((struct Int32List*)list_6))) = (struct Int32List){.head = 2, .tail = list_7};
    list_5 = ((struct Int32List const*)milone_region_alloc(1, sizeof(struct Int32List)));
    (*(((struct Int32List*)list_5))) = (struct Int32List){.head = 1, .tail = list_6};
...
end_match_15:;
    ...
    (*(((struct Int32List*)list_9))) = (struct Int32List){.head = 2, .tail = NULL};
    list_8 = ((struct Int32List const*)milone_region_alloc(1, sizeof(struct Int32List)));
    (*(((struct Int32List*)list_8))) = (struct Int32List){.head = 1, .tail = list_9};
    ...
    if ((!(Int32ListStringListTuple2_.t0))) goto next_19;
    if ((Int32ListStringListTuple2_.t0->head != 2)) goto next_19;
    if ((!(Int32ListStringListTuple2_.t0->tail))) goto next_19;
    if ((Int32ListStringListTuple2_.t0->tail->head != 1)) goto next_19;
    if ((!((!(Int32ListStringListTuple2_.t0->tail->tail))))) goto next_19;
    if ((!(Int32ListStringListTuple2_.t1))) goto next_19;
    if ((string_compare(Int32ListStringListTuple2_.t1->head, (struct String){.ptr = "b", .len = 1}) != 0)) goto next_19;
    if ((!(Int32ListStringListTuple2_.t1->tail))) goto next_19;
    if ((string_compare(Int32ListStringListTuple2_.t1->tail->head, (struct String){.ptr = "a", .len = 1}) != 0)) goto next_19;
    if ((!((!(Int32ListStringListTuple2_.t1->tail->tail))))) goto next_19;
    match_5 = 0;
    goto end_match_18;
next_19:;
...
end_match_18:;
    ...
    list_13 = ((struct Int32StringTuple2_List const*)milone_region_alloc(1, sizeof(struct Int32StringTuple2_List)));
    (*(((struct Int32StringTuple2_List*)list_13))) = (struct Int32StringTuple2_List){.head = Int32StringTuple2_3, .tail = NULL};
    list_12 = ((struct Int32StringTuple2_List const*)milone_region_alloc(1, sizeof(struct Int32StringTuple2_List)));
    (*(((struct Int32StringTuple2_List*)list_12))) = (struct Int32StringTuple2_List){.head = Int32StringTuple2_2, .tail = list_13};
