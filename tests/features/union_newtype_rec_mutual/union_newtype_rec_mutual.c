...
int milone_main() {
    ...
    struct Odd_ variant_ = ((struct Odd_){.discriminant = Odd_, .payload = {.Odd_ = box_}});
    ...
    struct Odd_ variant_1 = ((struct Odd_){.discriminant = Odd_, .payload = {.Odd_ = box_2}});
    ...
    int n3_ = (*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)four_))).t1.value.payload.Odd_))).t0;
    if ((!((*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)four_))).t1.value.payload.Odd_))).t1.some))) goto next_2;
    struct String s2_ = (*(((struct StringOdd_OptionTuple2 const*)(*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)four_))).t1.value.payload.Odd_))).t1.value))).t0;
    if ((!((*(((struct StringOdd_OptionTuple2 const*)(*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)four_))).t1.value.payload.Odd_))).t1.value))).t1.some))) goto next_2;
    int n1_ = (*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)(*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)four_))).t1.value.payload.Odd_))).t1.value))).t1.value.payload.Odd_))).t0;
    if ((*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)(*(((struct IntObjectOptionTuple2 const*)(*(((struct StringOdd_OptionTuple2 const*)four_))).t1.value.payload.Odd_))).t1.value))).t1.value.payload.Odd_))).t1.some) goto next_2;
