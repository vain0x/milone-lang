...
char union_unitlike_Program_usedInRecordTypeCase(char arg_2);
...
int milone_main() {
    char call_1 = union_unitlike_Program_basicCase(0);
    char call_2 = union_unitlike_Program_usedInOtherSumTypeCase(0);
    char call_3 = union_unitlike_Program_usedInRecordTypeCase(0);
    return 0;
}
