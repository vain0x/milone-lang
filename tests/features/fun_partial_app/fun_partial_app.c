...
int fun_partial_app_fun_partial_app_eta2_main_dec(void const* env_, int arg_) {
    ...
    int call_ = fun_partial_app_fun_partial_app_dec(arg_1, arg_);
    return call_;
}
...
int fun_partial_app_fun_partial_app_eta3_main_add4(void const* env_1, int arg_2, int arg_3) {
    ...
    int call_1 = fun_partial_app_fun_partial_app_add4(arg_4, arg_5, arg_2, arg_3);
    return call_1;
}

int fun_partial_app_fun_partial_app_eta5_main_add4(void const* env_2, int arg_6, int arg_7, int arg_8, int arg_9) {
    int call_2 = fun_partial_app_fun_partial_app_add4(arg_6, arg_7, arg_8, arg_9);
    return call_2;
}
...
int main(int argc, char** argv) {
    ...
    int call_3 = fun_partial_app_fun_partial_app_twice(dec3_, 8);
