...
void fun_with_fun_arg_fun_with_fun_arg_eta2_obj(void const* env_, struct String arg_) {
    struct IntStringUnitFun2 arg_1;
    int arg_2;
    arg_1 = (*(((struct IntStringUnitFun2IntTuple2_ const*)env_))).t0;
    arg_2 = (*(((struct IntStringUnitFun2IntTuple2_ const*)env_))).t1;
    arg_1.fun(arg_1.env, arg_2, arg_);
    return;
}

struct StringUnitFun1 fun_with_fun_arg_fun_with_fun_arg_bindInt(struct IntStringUnitFun2 f_, int x_) {
    struct IntStringUnitFun2 callee_;
    struct IntStringUnitFun2IntTuple2_ IntStringUnitFun2IntTuple2_;
    void const* box_;
...
int main(int argc, char** argv) {
    ...
    struct IntStringUnitFun2 fun_1;
    struct StringUnitFun1 call_;
    void const* box_1;
    struct IntStringUnitFun2 fun_2;
