...
next_13:;
    ...
    struct StringIntTuple2List* list_3 = milone_mem_alloc(1, sizeof(struct StringIntTuple2List));
    list_3->head = app_1;
    list_3->tail = call_3;
    match_3 = list_3;
    goto end_match_12;
...
int main() {
    ...
    list_4->tail = NULL;
    struct StringList* call_9 = id_1(list_4);
    ...
    struct IntList* list_7 = milone_mem_alloc(1, sizeof(struct IntList));
    list_7->head = 3;
    list_7->tail = NULL;
    ...
    list_5->head = 1;
    list_5->tail = list_6;
    struct IntList* call_10 = listMap_2(fun_4, list_5);
    struct IntList* call_11 = listMap_2(fun_3, call_10);
    int match_4;
...
end_match_15:;
    int match_5;
    struct IntList* list_9 = milone_mem_alloc(1, sizeof(struct IntList));
    list_9->head = 2;
    list_9->tail = NULL;
    struct IntList* list_8 = milone_mem_alloc(1, sizeof(struct IntList));
    list_8->head = 1;
    list_8->tail = list_9;
    struct IntList* call_14 = listRev_2(list_8);
    struct StringList* list_11 = milone_mem_alloc(1, sizeof(struct StringList));
    list_11->head = (struct String){.str = "b", .len = 1};
    list_11->tail = NULL;
    struct StringList* list_10 = milone_mem_alloc(1, sizeof(struct StringList));
    list_10->head = (struct String){.str = "a", .len = 1};
    list_10->tail = list_11;
    struct StringList* call_15 = listRev_1(list_10);
...
end_match_18:;
    ...
    struct IntStringTuple2List* list_13 = milone_mem_alloc(1, sizeof(struct IntStringTuple2List));
    list_13->head = tuple_5;
    list_13->tail = NULL;
    struct IntStringTuple2List* list_12 = milone_mem_alloc(1, sizeof(struct IntStringTuple2List));
    list_12->head = tuple_4;
    list_12->tail = list_13;
    struct StringIntTuple2List* call_16 = listMap_1(fun_5, list_12);
