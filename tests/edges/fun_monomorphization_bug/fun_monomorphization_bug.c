...
void const* fun_monomorphization_bug_fun_monomorphization_bug_IntIntTuple2ObjectFun1_myFst(struct IntIntTuple2_ pair_) {
    ...
    void const* call_ = fun_monomorphization_bug_fun_monomorphization_bug_myFst_ObjectObjectFun1_g(box_);
    return call_;
}
...
int main(int argc, char** argv) {
    ...
    void const* call_1 = fun_monomorphization_bug_fun_monomorphization_bug_IntIntTuple2ObjectFun1_myFst(IntIntTuple2_);
