...
int main(int argc, char** argv) {
    ...
    milone_assert((string_compare(app_, (struct String){.ptr = "x = 2, y = hi", .len = 13}) == 0), (struct String){.ptr = "fun_underlying_fun_forward_decl_issue/fun_underlying_fun_forward_decl_issue.milone", .len = 82}, 22, 2);
    return 0;
}
