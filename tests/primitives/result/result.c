...
then_23:;
    ...
    goto if_next_22;
else_24:;
    variant_1 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.str = "Odd", .len = 3}};
    if_ = variant_1;
    goto if_next_22;
if_next_22:;
    return if_;
...
void result_result_testBind(void) {
    ...
    variant_4 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.str = "Bad", .len = 3}};
...
void result_result_testMap(void) {
    ...
    variant_6 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.str = "Bad", .len = 3}};
...
void result_result_testMapError(void) {
    ...
    variant_8 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.str = "Bad", .len = 3}};
