...
int result_result_unwrapOk(struct IntStringResult2_ result_1) {
    ...
    goto end_match_16;
next_17:;
    call_ = result_result_IntStringResult2IntFun1_unexpected(result_1);
    match_2 = call_;
    goto end_match_16;
next_18:;
end_match_16:;
...
struct String result_result_unwrapError(struct IntStringResult2_ result_2) {
    ...
    goto end_match_19;
next_20:;
    call_1 = result_result_IntStringResult2StringFun1_unexpected(result_2);
    match_3 = call_1;
    goto end_match_19;
next_21:;
end_match_19:;
...
struct IntStringResult2_ result_result_testBind_divBy2(int n_) {
    ...
    struct IntStringResult2_ variant_;
    struct IntStringResult2_ variant_1;
    if (((n_ % 2) == 0)) {
        goto then_23;
    } else {
        goto else_24;
...
then_23:;
    variant_ = (struct IntStringResult2_){.discriminant = Ok_, .Ok_ = (n_ / 2)};
    if_ = variant_;
    goto if_next_22;
else_24:;
    variant_1 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.ptr = "Odd", .len = 3}};
    if_ = variant_1;
    goto if_next_22;
if_next_22:;
    return if_;
...
struct IntStringResult2_ result_result_eta2_testBind_divBy2(void const* env_, int arg_) {
    struct IntStringResult2_ call_2;
    call_2 = result_result_testBind_divBy2(arg_);
    return call_2;
}

struct IntStringResult2_ result_result_eta2_testBind_divBy2_1(void const* env_1, int arg_1) {
    struct IntStringResult2_ call_3;
    call_3 = result_result_testBind_divBy2(arg_1);
    return call_3;
}

struct IntStringResult2_ result_result_eta2_testBind_divBy2_2(void const* env_2, int arg_2) {
    struct IntStringResult2_ call_4;
    call_4 = result_result_testBind_divBy2(arg_2);
    return call_4;
}

void result_result_testBind(void) {
    struct IntIntStringResult2_Fun1 fun_;
    struct IntStringResult2_ variant_2;
    struct IntStringResult2_ call_5;
    int call_6;
    struct IntIntStringResult2_Fun1 fun_1;
    struct IntStringResult2_ variant_3;
    struct IntStringResult2_ call_7;
    struct String call_8;
    struct IntIntStringResult2_Fun1 fun_2;
    struct IntStringResult2_ variant_4;
    struct IntStringResult2_ call_9;
    struct String call_10;
    fun_ = (struct IntIntStringResult2_Fun1){.fun = result_result_eta2_testBind_divBy2, .env = NULL};
    variant_2 = (struct IntStringResult2_){.discriminant = Ok_, .Ok_ = 2};
    call_5 = MiloneCore_Result_IntIntStringResult2Fun1IntStringResult2IntStringResult2Fun2_bind(fun_, variant_2);
    call_6 = result_result_unwrapOk(call_5);
    milone_assert((call_6 == 1), (struct String){.ptr = "result/result.milone", .len = 20}, 29, 2);
    fun_1 = (struct IntIntStringResult2_Fun1){.fun = result_result_eta2_testBind_divBy2_1, .env = NULL};
    variant_3 = (struct IntStringResult2_){.discriminant = Ok_, .Ok_ = 3};
    call_7 = MiloneCore_Result_IntIntStringResult2Fun1IntStringResult2IntStringResult2Fun2_bind(fun_1, variant_3);
    ...
    fun_2 = (struct IntIntStringResult2_Fun1){.fun = result_result_eta2_testBind_divBy2_2, .env = NULL};
    variant_4 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.ptr = "Bad", .len = 3}};
    call_9 = MiloneCore_Result_IntIntStringResult2Fun1IntStringResult2IntStringResult2Fun2_bind(fun_2, variant_4);
...
void result_result_testMap(void) {
    struct IntIntFun1 fun_3;
    struct IntStringResult2_ variant_5;
    struct IntStringResult2_ call_13;
    int call_14;
    struct IntIntFun1 fun_4;
    struct IntStringResult2_ variant_6;
    struct IntStringResult2_ call_15;
    struct String call_16;
    fun_3 = (struct IntIntFun1){.fun = result_result_eta2_testMap_inc, .env = NULL};
    variant_5 = (struct IntStringResult2_){.discriminant = Ok_, .Ok_ = 2};
    call_13 = MiloneCore_Result_IntIntFun1IntStringResult2IntStringResult2Fun2_map(fun_3, variant_5);
    call_14 = result_result_unwrapOk(call_13);
    milone_assert((call_14 == 3), (struct String){.ptr = "result/result.milone", .len = 20}, 36, 2);
    fun_4 = (struct IntIntFun1){.fun = result_result_eta2_testMap_inc_1, .env = NULL};
    variant_6 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.ptr = "Bad", .len = 3}};
    call_15 = MiloneCore_Result_IntIntFun1IntStringResult2IntStringResult2Fun2_map(fun_4, variant_6);
...
void result_result_testMapError(void) {
    ...
    struct IntStringResult2_ variant_7;
    struct IntStringResult2_ call_19;
    int call_20;
    struct StringStringFun1 fun_6;
    struct IntStringResult2_ variant_8;
    struct IntStringResult2_ call_21;
    struct String call_22;
    fun_5 = (struct StringStringFun1){.fun = result_result_eta2_testMapError_bang, .env = NULL};
    variant_7 = (struct IntStringResult2_){.discriminant = Ok_, .Ok_ = 2};
    call_19 = MiloneCore_Result_StringStringFun1IntStringResult2IntStringResult2Fun2_mapError(fun_5, variant_7);
    ...
    variant_8 = (struct IntStringResult2_){.discriminant = Error_, .Error_ = (struct String){.ptr = "Bad", .len = 3}};
    call_21 = MiloneCore_Result_StringStringFun1IntStringResult2IntStringResult2Fun2_mapError(fun_6, variant_8);
