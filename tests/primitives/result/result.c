...
then_23:;
    variant_ = (struct Int32StringResult2_){.discriminant = Ok_, .Ok_ = (n_ / 2)};
    if_ = variant_;
    goto if_next_22;
else_24:;
    variant_1 = (struct Int32StringResult2_){.discriminant = Error_, .Error_ = (struct String){.ptr = "Odd", .len = 3}};
    if_ = variant_1;
    goto if_next_22;
if_next_22:;
    return if_;
