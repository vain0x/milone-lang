...
char fileWriteAllText_(struct String fileName_1, struct String content_);
...
int milone_main() {
    ...
    char call_1 = fileWriteAllText_((struct String){.str = "tests/primitives/effect_file_io/output.txt", .len = 42}, content_2);
    return 0;
}
