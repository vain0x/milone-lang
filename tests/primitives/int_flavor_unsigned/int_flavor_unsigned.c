...
int main(int argc, char** argv) {
    ...
    milone_assert((((int)(uint32_t)42U) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 6, 2);
    ...
    milone_assert((((int)call_) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 14, 2);
    ...
    milone_assert((((int)((uint32_t)40U + (uint32_t)2U)) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 18, 2);
    milone_assert((((int)((uint32_t)49U - (uint32_t)7U)) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 19, 2);
    milone_assert((((int)((uint32_t)6U * (uint32_t)7U)) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 20, 2);
    milone_assert((((int)((uint32_t)294U / (uint32_t)7U)) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 21, 2);
    milone_assert((((int)((uint32_t)2063U % (uint32_t)43U)) == 42), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 22, 2);
    milone_assert((((int)((((uint32_t)-1) - (uint32_t)1U) / (uint32_t)2U)) == 2147483647), (struct String){.ptr = "int_flavor_unsigned/int_flavor_unsigned.milone", .len = 46}, 25, 2);
