...
void list_equal_list_equal_testIntList(void) {
    ...
    list_12 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_12))) = (struct IntList){.head = 5, .tail = NULL};
    list_11 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_11))) = (struct IntList){.head = 3, .tail = list_12};
    list_10 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    ...
    list_16 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_16))) = (struct IntList){.head = 5, .tail = NULL};
    list_15 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_15))) = (struct IntList){.head = 2, .tail = list_16};
    list_14 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_14))) = (struct IntList){.head = 3, .tail = list_15};
    list_13 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    ...
    list_19 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_19))) = (struct IntList){.head = 3, .tail = NULL};
    list_18 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_18))) = (struct IntList){.head = 2, .tail = list_19};
    list_17 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_17))) = (struct IntList){.head = 2, .tail = list_18};
    list_23 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_23))) = (struct IntList){.head = 5, .tail = NULL};
    list_22 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_22))) = (struct IntList){.head = 3, .tail = list_23};
    list_21 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_21))) = (struct IntList){.head = 2, .tail = list_22};
    list_20 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    ...
    list_26 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_26))) = (struct IntList){.head = 5, .tail = NULL};
    list_25 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_25))) = (struct IntList){.head = 3, .tail = list_26};
    list_24 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_24))) = (struct IntList){.head = 2, .tail = list_25};
    list_30 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_30))) = (struct IntList){.head = 5, .tail = NULL};
    list_29 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_29))) = (struct IntList){.head = 3, .tail = list_30};
    list_28 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
    (*(((struct IntList*)list_28))) = (struct IntList){.head = 2, .tail = list_29};
    list_27 = ((struct IntList const*)milone_region_alloc(1, sizeof(struct IntList)));
...
void list_equal_list_equal_testPairList(void) {
    ...
    bool call_9;
    IntStringTuple2_ = (struct IntStringTuple2_){.t0 = 1, .t1 = (struct String){.ptr = "a", .len = 1}};
    IntStringTuple2_1 = (struct IntStringTuple2_){.t0 = 2, .t1 = (struct String){.ptr = "b", .len = 1}};
    list_32 = ((struct IntStringTuple2_List const*)milone_region_alloc(1, sizeof(struct IntStringTuple2_List)));
    (*(((struct IntStringTuple2_List*)list_32))) = (struct IntStringTuple2_List){.head = IntStringTuple2_1, .tail = NULL};
    list_31 = ((struct IntStringTuple2_List const*)milone_region_alloc(1, sizeof(struct IntStringTuple2_List)));
    ...
    list_34 = ((struct IntStringTuple2_List const*)milone_region_alloc(1, sizeof(struct IntStringTuple2_List)));
    (*(((struct IntStringTuple2_List*)list_34))) = (struct IntStringTuple2_List){.head = IntStringTuple2_3, .tail = NULL};
    list_33 = ((struct IntStringTuple2_List const*)milone_region_alloc(1, sizeof(struct IntStringTuple2_List)));
