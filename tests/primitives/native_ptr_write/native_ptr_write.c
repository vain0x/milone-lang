...
int main(int argc, char** argv) {
    ...
    struct UInt64UInt64Tuple2_ UInt64UInt64Tuple2_ = (struct UInt64UInt64Tuple2_){.t0 = 0ULL, .t1 = 0ULL};
    ...
    (*(buf_)) = 'H';
    buf_[1] = 'i';
    struct String call_ = native_ptr_write_native_ptr_write_strOfRawParts(((char const*)buf_), 2);
