...
void nativeptr_nativeptr_testBasic(void) {
    ...
    if (((*(((int32_t const *)buf_))) != -1)) milone_assert_error("nativeptr/nativeptr.milone", 23, 2);
    address_1 = ((uintptr_t)buf_);
    if ((address_1 == (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 26, 2);
    return;
}
...
void nativeptr_nativeptr_testVoidPtrAvailable(void) {
    ...
    if ((((uintptr_t)constEnv_) != (size_t)42ULL)) milone_assert_error("nativeptr/nativeptr.milone", 31, 2);
    return;
}
...
void nativeptr_nativeptr_testNullPtr(void) {
    ...
    nullVoidPtr_ = NULL;
    if ((((uintptr_t)nullVoidPtr_) != (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 35, 2);
    nullVoidInPtr_ = NULL;
    if ((((uintptr_t)nullVoidInPtr_) != (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 38, 2);
    nullNativePtr_ = ((double *)NULL);
    if ((((uintptr_t)nullNativePtr_) != (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 41, 2);
    nullInPtr_ = ((double const *)NULL);
    if ((((uintptr_t)nullInPtr_) != (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 44, 2);
    nullOutPtr_ = ((double *)NULL);
    if ((((uintptr_t)nullOutPtr_) != (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 47, 2);
    nullFunPtr_ = ((VoidFunPtr0)NULL);
    if ((((uintptr_t)nullFunPtr_) != (size_t)0ULL)) milone_assert_error("nativeptr/nativeptr.milone", 50, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrInvalid(void) {
    ...
    if ((address_2 != (size_t)8ULL)) milone_assert_error("nativeptr/nativeptr.milone", 54, 2);
    n_ = 42;
    address_3 = ((uintptr_t)(&(n_)));
    address_ = address_3;
    exposedPtr_ = ((int32_t *)address_);
    if (((*(exposedPtr_)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 59, 2);
    return;
}
...
void nativeptr_nativeptr_testAsIn(void) {
    ...
    if ((kp_ != ((int32_t const *)NULL))) milone_assert_error("nativeptr/nativeptr.milone", 83, 2);
    mq_ = NULL;
    kq_ = ((void const *)mq_);
    if ((kq_ != NULL)) milone_assert_error("nativeptr/nativeptr.milone", 88, 2);
    return;
}
...
void nativeptr_nativeptr_testAsNative(void) {
    ...
    mp_1 = ((int32_t *)kp_1);
    if ((mp_1 != ((int32_t *)NULL))) milone_assert_error("nativeptr/nativeptr.milone", 94, 2);
    kq_1 = NULL;
    mq_1 = ((void *)kq_1);
    if ((mq_1 != NULL)) milone_assert_error("nativeptr/nativeptr.milone", 99, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrDistance(void) {
    ...
    if (((p_ - p_) != 0LL)) milone_assert_error("nativeptr/nativeptr.milone", 104, 2);
    if (((q_ - p_) != 8LL)) milone_assert_error("nativeptr/nativeptr.milone", 105, 2);
    if (((p_ - q_) != -8LL)) milone_assert_error("nativeptr/nativeptr.milone", 106, 2);
    return;
}
...
void nativeptr_nativeptr_testEquality(void) {
    ...
    if ((p_1 == np_)) milone_assert_error("nativeptr/nativeptr.milone", 111, 2);
    nq_ = ((int32_t const *)NULL);
    q_1 = ((int32_t const *)(size_t)42ULL);
    if ((q_1 == nq_)) milone_assert_error("nativeptr/nativeptr.milone", 115, 2);
    return;
}
...
void nativeptr_nativeptr_testSizeOf(void) {
    int32_t w_;
    int32_t call_1;
    if ((sizeof(char) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 120, 2);
    if ((sizeof(uint8_t) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 121, 2);
    if ((sizeof(int16_t) != 2)) milone_assert_error("nativeptr/nativeptr.milone", 122, 2);
    if ((sizeof(int32_t) != 4)) milone_assert_error("nativeptr/nativeptr.milone", 123, 2);
    if ((sizeof(int64_t) != 8)) milone_assert_error("nativeptr/nativeptr.milone", 124, 2);
    w_ = sizeof(uintptr_t);
    if ((sizeof(void *) != w_)) milone_assert_error("nativeptr/nativeptr.milone", 127, 2);
    if ((sizeof(struct ObjectObjectTuple2_ *) != w_)) milone_assert_error("nativeptr/nativeptr.milone", 128, 2);
    if ((sizeof(struct String) != (w_ * 2))) milone_assert_error("nativeptr/nativeptr.milone", 129, 2);
    if ((sizeof(struct UnitUnitFun1) != (w_ * 2))) milone_assert_error("nativeptr/nativeptr.milone", 130, 2);
    if ((sizeof(struct Int64UInt8UInt8Tuple3_) != 16)) milone_assert_error("nativeptr/nativeptr.milone", 132, 2);
    call_1 = nativeptr_nativeptr_ObjectObjectTuple2MutPtrInt32Fun1_sizeOfPointee(((struct ObjectObjectTuple2_ *)NULL));
    if ((call_1 != sizeof(struct ObjectObjectTuple2_))) milone_assert_error("nativeptr/nativeptr.milone", 135, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrOf(void) {
    ...
    x_ = 42;
    p_2 = (&(x_));
    if (((*(p_2)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 140, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrSelect(void) {
    ...
    p_3 = ((int32_t *)call_2);
    if (((&(p_3[0])) != p_3)) milone_assert_error("nativeptr/nativeptr.milone", 146, 2);
    address_4 = ((uintptr_t)(&(p_3[1])));
    address_5 = ((uintptr_t)p_3);
    if (((address_4 - address_5) != ((uintptr_t)sizeof(int32_t)))) milone_assert_error("nativeptr/nativeptr.milone", 147, 2);
    return;
}
...
int array[] = {1, 2, 4, 8, 16};    p_4 = array;
    if (((*(p_4)) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 153, 2);
    if ((p_4[0] != 1)) milone_assert_error("nativeptr/nativeptr.milone", 154, 2);
    if ((p_4[4] != 16)) milone_assert_error("nativeptr/nativeptr.milone", 155, 2);
    q_2 = ((int32_t const *)p_4);
    if (((*(q_2)) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 158, 2);
    if ((q_2[2] != 4)) milone_assert_error("nativeptr/nativeptr.milone", 159, 2);
    return;
}
...
int data[8] = { 0 };    p_5 = data;
    (*(p_5)) = 42;
    if (((*(p_5)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 166, 2);
    p_5[0] = 43;
    if (((*(p_5)) != 43)) milone_assert_error("nativeptr/nativeptr.milone", 168, 2);
    p_5[3] = 39;
    if ((p_5[3] != 39)) milone_assert_error("nativeptr/nativeptr.milone", 170, 2);
    q_3 = &data[7];
    (*(q_3)) = 77;
    q_4 = ((int32_t *)q_3);
    if (((*(q_4)) != 77)) milone_assert_error("nativeptr/nativeptr.milone", 175, 2);
    return;
}
...
void nativeptr_nativeptr_testRegionAlloc(void) {
    ...
    p_6[1] = 43;
    p_7 = ((int32_t *)p_6);
    if (((*(p_7)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 184, 2);
    if ((p_7[1] != 43)) milone_assert_error("nativeptr/nativeptr.milone", 185, 2);
    return;
}
