...
int32_t* Std_Ptr_Int32Int32OutPtrFun1_regionAlloc(int32_t );
...
void nativeptr_nativeptr_testBasic(void) {
    ...
    milone_assert(((*(((int32_t const*)buf_))) == -1), (struct String){.ptr = "nativeptr/nativeptr.milone", .len = 26}, 20, 2);
...
void nativeptr_nativeptr_testAsIn(void) {
    ...
    milone_assert((kp_ == ((int32_t const*)NULL)), (struct String){.ptr = "nativeptr/nativeptr.milone", .len = 26}, 80, 2);
    mq_ = NULL;
    kq_ = ((void const*)mq_);
...
void nativeptr_nativeptr_testAsNative(void) {
    ...
    mp_1 = ((int32_t*)kp_1);
    milone_assert((mp_1 == ((int32_t*)NULL)), (struct String){.ptr = "nativeptr/nativeptr.milone", .len = 26}, 91, 2);
    kq_1 = NULL;
    mq_1 = ((void*)kq_1);
...
void nativeptr_nativeptr_testSizeOf(void) {
    ...
    milone_assert((sizeof(int32_t) == 4), (struct String){.ptr = "nativeptr/nativeptr.milone", .len = 26}, 120, 2);
...
void nativeptr_nativeptr_testPtrSelect(void) {
    ...
    milone_assert(((address_4 - address_5) == ((uintptr_t)sizeof(int32_t))), (struct String){.ptr = "nativeptr/nativeptr.milone", .len = 26}, 143, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrRegionAlloc(void) {
    ...
    int32_t* p_7;
    int32_t* call_3;
    call_3 = Std_Ptr_Int32Int32OutPtrFun1_regionAlloc(2);
    p_6 = call_3;
    p_6[0] = 42;
    p_6[1] = 43;
    p_7 = ((int32_t*)p_6);
