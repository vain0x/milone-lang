...
void nativeptr_nativeptr_testPtrInvalid(void) {
    ...
    address_1 = ((uintptr_t)danglingPtr_);
    if ((address_1 != (size_t)8ULL)) milone_assert_error("nativeptr/nativeptr.milone", 50, 2);
    return;
}
...
void nativeptr_nativeptr_testAsIn(void) {
    ...
    if ((kp_ != ((int32_t const *)NULL))) milone_assert_error("nativeptr/nativeptr.milone", 73, 2);
    mq_ = NULL;
    kq_ = ((void const *)mq_);
    if ((kq_ != NULL)) milone_assert_error("nativeptr/nativeptr.milone", 78, 2);
    return;
}
...
void nativeptr_nativeptr_testAsNative(void) {
    ...
    mp_1 = ((int32_t *)kp_1);
    if ((mp_1 != ((int32_t *)NULL))) milone_assert_error("nativeptr/nativeptr.milone", 84, 2);
    kq_1 = NULL;
    mq_1 = ((void *)kq_1);
    if ((mq_1 != NULL)) milone_assert_error("nativeptr/nativeptr.milone", 89, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrDistance(void) {
    ...
    if (((p_ - p_) != 0LL)) milone_assert_error("nativeptr/nativeptr.milone", 94, 2);
    if (((q_ - p_) != 8LL)) milone_assert_error("nativeptr/nativeptr.milone", 95, 2);
    if (((p_ - q_) != -8LL)) milone_assert_error("nativeptr/nativeptr.milone", 96, 2);
    return;
}
...
void nativeptr_nativeptr_testEquality(void) {
    ...
    if ((p_1 == np_)) milone_assert_error("nativeptr/nativeptr.milone", 101, 2);
    nq_ = ((int32_t const *)NULL);
    q_1 = ((int32_t const *)(size_t)42ULL);
    if ((q_1 == nq_)) milone_assert_error("nativeptr/nativeptr.milone", 105, 2);
    return;
}
...
void nativeptr_nativeptr_testSizeOf(void) {
    int32_t w_;
    int32_t call_1;
    if ((sizeof(char) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 110, 2);
    if ((sizeof(uint8_t) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 111, 2);
    if ((sizeof(int16_t) != 2)) milone_assert_error("nativeptr/nativeptr.milone", 112, 2);
    if ((sizeof(int32_t) != 4)) milone_assert_error("nativeptr/nativeptr.milone", 113, 2);
    if ((sizeof(int64_t) != 8)) milone_assert_error("nativeptr/nativeptr.milone", 114, 2);
    w_ = sizeof(uintptr_t);
    if ((sizeof(void *) != w_)) milone_assert_error("nativeptr/nativeptr.milone", 117, 2);
    if ((sizeof(struct ObjectObjectTuple2_ *) != w_)) milone_assert_error("nativeptr/nativeptr.milone", 118, 2);
    if ((sizeof(struct String) != (w_ * 2))) milone_assert_error("nativeptr/nativeptr.milone", 119, 2);
    if ((sizeof(struct UnitUnitFun1) != (w_ * 2))) milone_assert_error("nativeptr/nativeptr.milone", 120, 2);
    if ((sizeof(struct Int64UInt8UInt8Tuple3_) != 16)) milone_assert_error("nativeptr/nativeptr.milone", 122, 2);
    call_1 = nativeptr_nativeptr_ObjectObjectTuple2MutPtrInt32Fun1_sizeOfPointee(((struct ObjectObjectTuple2_ *)NULL));
    if ((call_1 != sizeof(struct ObjectObjectTuple2_))) milone_assert_error("nativeptr/nativeptr.milone", 125, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrOf(void) {
    ...
    x_ = 42;
    p_2 = (&(x_));
    if (((*(p_2)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 130, 2);
    return;
}
...
void nativeptr_nativeptr_testPtrSelect(void) {
    ...
    address_3 = ((uintptr_t)p_3);
    if (((address_2 - address_3) != ((uintptr_t)sizeof(int32_t)))) milone_assert_error("nativeptr/nativeptr.milone", 137, 2);
    return;
}
...
int array[] = {1, 2, 4, 8, 16};    p_4 = array;
    if (((*(p_4)) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 143, 2);
    if ((p_4[0] != 1)) milone_assert_error("nativeptr/nativeptr.milone", 144, 2);
    if ((p_4[4] != 16)) milone_assert_error("nativeptr/nativeptr.milone", 145, 2);
    q_2 = ((int32_t const *)p_4);
    if (((*(q_2)) != 1)) milone_assert_error("nativeptr/nativeptr.milone", 148, 2);
    if ((q_2[2] != 4)) milone_assert_error("nativeptr/nativeptr.milone", 149, 2);
    return;
}
...
int data[8] = { 0 };    p_5 = data;
    (*(p_5)) = 42;
    if (((*(p_5)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 156, 2);
    p_5[0] = 43;
    if (((*(p_5)) != 43)) milone_assert_error("nativeptr/nativeptr.milone", 158, 2);
    p_5[3] = 39;
    if ((p_5[3] != 39)) milone_assert_error("nativeptr/nativeptr.milone", 160, 2);
    q_3 = &data[7];
    (*(q_3)) = 77;
    q_4 = ((int32_t *)q_3);
    if (((*(q_4)) != 77)) milone_assert_error("nativeptr/nativeptr.milone", 165, 2);
    return;
}
...
void nativeptr_nativeptr_testRegionAlloc(void) {
    ...
    p_6[1] = 43;
    p_7 = ((int32_t *)p_6);
    if (((*(p_7)) != 42)) milone_assert_error("nativeptr/nativeptr.milone", 174, 2);
    if ((p_7[1] != 43)) milone_assert_error("nativeptr/nativeptr.milone", 175, 2);
    return;
}
