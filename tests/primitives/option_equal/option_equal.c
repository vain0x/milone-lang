...
bool MiloneDerive_OptionEqual_optionEqual(struct IntOption_ l_, struct IntOption_ r_);

bool MiloneDerive_TupleEqual_tuple2Equal(struct IntStringTuple2_ , struct IntStringTuple2_ );

bool MiloneDerive_OptionEqual_optionEqual_1(struct IntStringTuple2Option_ l_2, struct IntStringTuple2Option_ r_2);

bool MiloneDerive_OptionEqual_optionEqual(struct IntOption_ , struct IntOption_ );

void option_equal_option_equal_testIntOption(void);

bool MiloneDerive_OptionEqual_optionEqual_1(struct IntStringTuple2Option_ , struct IntStringTuple2Option_ );
...
void option_equal_option_equal_testIntOption(void) {
    ...
    bool call_1 = MiloneDerive_OptionEqual_optionEqual(some_, variant_1);
    milone_assert(call_1, 6, 2);
    struct IntOption_ variant_2 = (struct IntOption_){.discriminant = Some_, .Some_ = 3};
    bool call_2 = MiloneDerive_OptionEqual_optionEqual(some_, variant_2);
    milone_assert((!(call_2)), 7, 2);
    bool call_3 = MiloneDerive_OptionEqual_optionEqual(some_, (struct IntOption_){.discriminant = None_});
    milone_assert((!(call_3)), 8, 2);
    struct IntOption_ none_ = (struct IntOption_){.discriminant = None_};
    bool call_4 = MiloneDerive_OptionEqual_optionEqual(none_, (struct IntOption_){.discriminant = None_});
    milone_assert(call_4, 11, 2);
    bool call_5 = MiloneDerive_OptionEqual_optionEqual(none_, some_);
...
void option_equal_option_equal_testPair(void) {
    ...
    bool call_6 = MiloneDerive_OptionEqual_optionEqual_1(variant_3, variant_4);
    ...
    bool call_7 = MiloneDerive_OptionEqual_optionEqual_1(variant_5, variant_6);
