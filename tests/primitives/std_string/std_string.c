...
tailrec_76:;
    ...
    if ((!((!(xs_6))))) goto next_78;
    match_ = acc_;
    goto end_match_77;
next_78:;
    if ((!(xs_6))) goto next_79;
...
bool contains_(struct String substr_3, struct String s_6) {
    ...
    if ((!(call_19.some))) goto next_120;
    match_1 = true;
    goto end_match_119;
next_120:;
    if (call_19.some) goto next_121;
    match_1 = false;
    goto end_match_119;
next_121:;
    exit(1);
...
if_next_219:;
    ...
    (*(((struct StringList*)list_3))) = (struct StringList){.head = if_66, .tail = acc_15};
...
bool isNone_1(struct IntOption opt_) {
    bool match_4;
    if (opt_.some) goto next_241;
    match_4 = true;
    goto end_match_240;
next_241:;
    if ((!(opt_.some))) goto next_242;
    match_4 = false;
    goto end_match_240;
next_242:;
    exit(1);
...
int unwrap_1(struct IntOption opt_8) {
    int match_6;
    if ((!(opt_8.some))) goto next_247;
    int value_2 = opt_8.value;
    match_6 = value_2;
    goto end_match_246;
next_247:;
    if (opt_8.some) goto next_248;
    printf("Can\'t unwrap None.\n");
    exit(1);
    match_6 = 0;
    goto end_match_246;
