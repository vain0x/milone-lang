...
void std_string_Program_splitTest(void);

void std_string_Program_concatTest(void);
...
int milone_main(void) {
    std_string_Program_isEmptyTest();
    std_string_Program_tryItemTest();
    std_string_Program_startsWithTest();
    std_string_Program_endsWithTest();
    std_string_Program_findIndexTest();
    std_string_Program_findLastIndexTest();
    std_string_Program_containsTest();
    std_string_Program_truncateTest();
    std_string_Program_skipTest();
    std_string_Program_sliceTest();
    std_string_Program_trimTest();
    std_string_Program_replaceTest();
    std_string_Program_splitTest();
    std_string_Program_concatTest();
    return 0;
}
