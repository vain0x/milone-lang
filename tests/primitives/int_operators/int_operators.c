...
void int_operators_int_operators_literalTest(void) {
    milone_assert(((-(((int32_t)0x80000000 + 1))) == 2147483647), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 4, 2);
    return;
}

void int_operators_int_operators_hexLiteralTest(void) {
    milone_assert(((int32_t)0x00000000 == 0), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 7, 2);
    milone_assert(((int32_t)0x10 == 16), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 8, 2);
    milone_assert(((int32_t)0x7fffffff == 2147483647), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 9, 2);
    milone_assert(((int32_t)0xffffffff == -1), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 10, 2);
    return;
}
...
void int_operators_int_operators_arithmeticOperatorsTest(int two_, int three_, int thirtyNine_) {
    ...
    milone_assert(((thirtyNine_ / two_) == 19), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 16, 2);
    milone_assert(((thirtyNine_ / three_) == 13), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 17, 2);
    milone_assert(((thirtyNine_ % two_) == 1), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 18, 2);
    milone_assert(((thirtyNine_ % three_) == 0), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 19, 2);
    milone_assert(((-(two_)) == -2), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 21, 2);
    return;
}
...
void int_operators_int_operators_bitOperatorsTest(int n1_) {
    ...
    n8_ = (n4_ * 2);
    n16_ = (n8_ * 2);
    milone_assert(((((n1_ + n2_) + n4_) & ((n2_ + n4_) + n8_)) == (n2_ + n4_)), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 29, 2);
    milone_assert(((((n1_ + n2_) + n4_) | ((n2_ + n4_) + n8_)) == (((n1_ + n2_) + n4_) + n8_)), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 30, 2);
    milone_assert(((((n1_ + n2_) + n4_) ^ ((n2_ + n4_) + n8_)) == (n1_ + n8_)), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 31, 2);
    milone_assert(((n1_ << 0) == n1_), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 33, 2);
    milone_assert(((n1_ << 1) == n2_), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 34, 2);
    milone_assert(((((n1_ + n2_) + n8_) << 1) == ((n2_ + n4_) + n16_)), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 35, 2);
    milone_assert(((n4_ >> 0) == n4_), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 37, 2);
    milone_assert(((n4_ >> 1) == n2_), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 38, 2);
    milone_assert(((n4_ >> 2) == n1_), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 39, 2);
    milone_assert(((n4_ >> 3) == 0), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 40, 2);
    milone_assert(((((n1_ + n2_) + n8_) >> 1) == ((0 + n1_) + n4_)), (struct String){.ptr = "int_operators/int_operators.milone", .len = 34}, 41, 2);
    return;
}
