...
void native_code_native_code_nativeStmtWithTyPlaceholder(void) {
    uintptr_t call_ = native_code_native_code_CharMutPtrUIntPtrFun1_alignOf(((char*)0LL));
    milone_assert((call_ == (size_t)1ULL), (struct String){.str = "native_code/native_code.milone", .len = 30}, 37, 2);
    uintptr_t call_1 = native_code_native_code_IntMutPtrUIntPtrFun1_alignOf(((int*)0LL));
    milone_assert((call_1 == (size_t)4ULL), (struct String){.str = "native_code/native_code.milone", .len = 30}, 38, 2);
    uintptr_t call_2 = native_code_native_code_IntUnitFun1MutPtrUIntPtrFun1_alignOf(((struct IntUnitFun1*)0LL));
...
int main(int argc, char** argv) {
    ...
    int call_3 = native_code_native_code_freshId();
    struct String call_4 = str_of_int64(call_3);
    native_code_native_code_writeLine(call_4);
    int call_5 = native_code_native_code_freshId();
