...
int main(int argc, char** argv) {
    ...
    double call_6;
    list_7 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_7))) = (struct F64List){.head = 00.00e-00, .tail = NULL};
    list_6 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_6))) = (struct F64List){.head = 0E-9, .tail = list_7};
    list_5 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_5))) = (struct F64List){.head = 0E+9, .tail = list_6};
    list_4 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_4))) = (struct F64List){.head = 0E0, .tail = list_5};
    list_3 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_3))) = (struct F64List){.head = 0e0, .tail = list_4};
    list_2 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_2))) = (struct F64List){.head = 000.000, .tail = list_3};
    list_1 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_1))) = (struct F64List){.head = 0., .tail = list_2};
    list_ = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    ...
    list_18 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_18))) = (struct F64List){.head = 6.02e-23, .tail = NULL};
    list_17 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_17))) = (struct F64List){.head = 1e-23, .tail = list_18};
    list_16 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_16))) = (struct F64List){.head = 1e+23, .tail = list_17};
    list_15 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_15))) = (struct F64List){.head = 1E-9, .tail = list_16};
    list_14 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_14))) = (struct F64List){.head = 1e-9, .tail = list_15};
    list_13 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_13))) = (struct F64List){.head = 1E+9, .tail = list_14};
    list_12 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_12))) = (struct F64List){.head = 1e+9, .tail = list_13};
    list_11 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_11))) = (struct F64List){.head = 1E9, .tail = list_12};
    list_10 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_10))) = (struct F64List){.head = 1e9, .tail = list_11};
    list_9 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
    (*(((struct F64List*)list_9))) = (struct F64List){.head = 42.195, .tail = list_10};
    list_8 = ((struct F64List const*)milone_mem_alloc(1, sizeof(struct F64List)));
