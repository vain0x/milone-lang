...
int main(int argc, char **argv) {
    ...
    if ((!(call_1))) goto next_2;
    if ((call_1->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x1_ = call_1->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!(call_1->tail))) goto next_2;
    if ((call_1->tail->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->tail->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x2_ = call_1->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!(call_1->tail->tail))) goto next_2;
    if ((call_1->tail->tail->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x3_ = call_1->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!(call_1->tail->tail->tail))) goto next_2;
    if ((call_1->tail->tail->tail->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x4_ = call_1->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!(call_1->tail->tail->tail->tail))) goto next_2;
    if ((call_1->tail->tail->tail->tail->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->tail->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x5_ = call_1->tail->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!(call_1->tail->tail->tail->tail->tail))) goto next_2;
    if ((call_1->tail->tail->tail->tail->tail->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->tail->tail->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x6_ = call_1->tail->tail->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!(call_1->tail->tail->tail->tail->tail->tail))) goto next_2;
    if ((call_1->tail->tail->tail->tail->tail->tail->head.discriminant != Int32option1option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->tail->tail->tail->head.Int32option1option1option1_Some.discriminant != Int32option1option1_Some)) goto next_2;
    if ((call_1->tail->tail->tail->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.discriminant != Int32option1_Some)) goto next_2;
    x7_ = call_1->tail->tail->tail->tail->tail->tail->head.Int32option1option1option1_Some.Int32option1option1_Some.Int32option1_Some;
    if ((!((!(call_1->tail->tail->tail->tail->tail->tail->tail))))) goto next_2;
