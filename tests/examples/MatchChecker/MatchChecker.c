...
next_15:;
    ...
    struct Space_Space_Tuple2 x_ = xs_2->head;
    ...
    (*(((struct Space_Space_Tuple2List*)list_4))) = (struct Space_Space_Tuple2List){.head = x_, .tail = acc_};
...
next_31:;
    ...
    struct StringSpace_Tuple2 x_1 = xs_5->head;
...
next_35:;
    ...
    struct StringTy_Pat_ListCovering_Tuple4 x_1 = xs_5->head;
...
next_39:;
    ...
    struct Space_Space_Tuple2 x_2 = xs_8->head;
...
next_54:;
    ...
    struct Space_Space_Tuple2 x_3 = xs_11->head;
...
next_84:;
    ...
    goto match_body_83;
match_body_83:;
    struct Space_Space_Tuple2List const* call_24 = listRev_2(acc_3);
    match_17 = call_24;
    goto end_match_82;
next_85:;
    if ((!(tuple_.t0))) goto next_86;
    struct Space_ x_6 = tuple_.t0->head;
    ...
    struct Space_Space_Tuple2 tuple_1 = (struct Space_Space_Tuple2){.t0 = x_6, .t1 = y_};
...
bool MatchChecker_Program_spaceIsEmpty(struct Space_ space_3) {
    ...
    bool call_35 = listExists_(fun_29, spaces_6);
    match_21 = call_35;
    goto end_match_100;
next_101:;
    ...
    bool call_36 = listForAll_2(fun_30, spaces_7);
    match_21 = call_36;
    goto end_match_100;
next_102:;
    match_21 = false;
...
struct Space_ fun_28(struct String tag_2, struct Space_List const* firsts_, struct Space_List const* seconds_, int i_1, struct Space_ arg_87) {
    struct IntSpace_Space_Tuple2Space_Fun2 fun_31 = (struct IntSpace_Space_Tuple2Space_Fun2){.fun = fun_12, .env = ((void const*)((intptr_t)i_1))};
    struct Space_Space_Tuple2List const* call_42 = listZip_(firsts_, seconds_);
    struct Space_List const* call_43 = listMapWithIndex_1(fun_31, call_42);
...
tailrec_110:;
    ...
    struct Space_Space_Tuple2 tuple_4 = (struct Space_Space_Tuple2){.t0 = first_, .t1 = second_};
    if ((tuple_4.t0.discriminant != Union_)) goto next_112;
    if ((!((!(tuple_4.t0.Union_))))) goto next_112;
    match_23 = MatchChecker_Program_spaceEmpty;
    goto end_match_111;
next_112:;
    if ((tuple_4.t1.discriminant != Union_)) goto next_113;
    if ((!((!(tuple_4.t1.Union_))))) goto next_113;
    match_23 = first_;
    goto end_match_111;
next_113:;
    if ((tuple_4.t1.discriminant != Full_)) goto next_114;
    match_23 = MatchChecker_Program_spaceEmpty;
    goto end_match_111;
next_114:;
    if ((tuple_4.t0.discriminant != Full_)) goto next_115;
    if ((tuple_4.t1.discriminant != Ctor_)) goto next_115;
    match_23 = MatchChecker_Program_spaceFull;
    goto end_match_111;
next_115:;
    if ((tuple_4.t0.discriminant != Ctor_)) goto next_116;
    struct String tag_2 = tuple_4.t0.Ctor_.t0;
    struct Space_List const* firsts_ = tuple_4.t0.Ctor_.t1;
    if ((tuple_4.t1.discriminant != Ctor_)) goto next_116;
    struct String secondTag_ = tuple_4.t1.Ctor_.t0;
    struct Space_List const* seconds_ = tuple_4.t1.Ctor_.t1;
    ...
    struct Space_Space_Tuple2List const* call_49 = listZip_(firsts_, seconds_);
    bool call_50 = listForAll_1(fun_32, call_49);
...
then_124:;
    ...
    goto if_next_123;
else_125:;
    struct StringSpace_ListSpace_ListTuple3 tuple_5 = (struct StringSpace_ListSpace_ListTuple3){.t0 = tag_2, .t1 = firsts_, .t2 = seconds_};
    void const* box_1 = milone_mem_alloc(1, sizeof(struct StringSpace_ListSpace_ListTuple3));
    (*(((struct StringSpace_ListSpace_ListTuple3*)box_1))) = tuple_5;
    struct IntSpace_Space_Fun2 fun_33 = (struct IntSpace_Space_Fun2){.fun = fun_13, .env = box_1};
    struct Space_List const* call_51 = listMapWithIndex_(fun_33, firsts_);
...
if_next_123:;
    ...
    goto end_match_111;
next_116:;
    if ((tuple_4.t0.discriminant != Ctor_)) goto next_117;
    if ((tuple_4.t1.discriminant != Ctor_)) goto next_117;
    match_23 = first_;
    goto end_match_111;
next_117:;
    if ((tuple_4.t1.discriminant != Union_)) goto next_118;
    struct Space_List const* seconds_1 = tuple_4.t1.Union_;
    struct Space_Space_Space_Fun2 fun_34 = (struct Space_Space_Space_Fun2){.fun = fun_14, .env = NULL};
    struct Space_ call_53 = listFold_1(fun_34, first_, seconds_1);
    match_23 = call_53;
    goto end_match_111;
next_118:;
    if ((tuple_4.t0.discriminant != Union_)) goto next_119;
    struct Space_List const* firsts_1 = tuple_4.t0.Union_;
    void const* box_2 = milone_mem_alloc(1, sizeof(struct Space_));
    (*(((struct Space_*)box_2))) = second_;
    struct Space_Space_Fun1 fun_35 = (struct Space_Space_Fun1){.fun = fun_15, .env = box_2};
    struct Space_List const* call_54 = listMap_4(fun_35, firsts_1);
    struct Space_ call_55 = MatchChecker_Program_spaceUnion(call_54);
    match_23 = call_55;
    goto end_match_111;
next_119:;
    if ((tuple_4.t0.discriminant != Ref_)) goto next_120;
    struct String tag_3 = (*(((struct StringUnitSpace_Fun1Tuple2 const*)tuple_4.t0.Ref_))).t0;
    if ((tuple_4.t1.discriminant != Ref_)) goto next_120;
    struct String secondTag_1 = (*(((struct StringUnitSpace_Fun1Tuple2 const*)tuple_4.t1.Ref_))).t0;
    if ((str_compare(tag_3, secondTag_1) != 0)) goto next_120;
    match_23 = MatchChecker_Program_spaceEmpty;
    goto end_match_111;
next_120:;
    if ((tuple_4.t0.discriminant != Ref_)) goto next_121;
    ...
    goto tailrec_110;
next_121:;
    if ((tuple_4.t1.discriminant != Ref_)) goto next_122;
...
next_128:;
    ...
    struct StringList const* call_68 = cons_(tag_5, acc_5);
    ...
    struct StringList const* call_71 = listFold_(fun_36, acc_6, items_1);
...
next_129:;
    ...
    struct StringList const* call_73 = cons_(tag_6, acc_5);
    match_24 = call_73;
    goto end_match_126;
next_130:;
...
next_131:;
    ...
    struct StringList const* call_77 = listFold_(fun_37, acc_8, subspaces_1);
...
struct Space_ thunk_2(struct Space_ itemSpace_, char arg_92) {
    ...
    struct UnitSpace_Fun1 fun_38 = (struct UnitSpace_Fun1){.fun = fun_19, .env = box_3};
    struct Space_ call_86 = MatchChecker_Program_spaceRef((struct String){.str = "list", .len = 4}, fun_38);
...
next_135:;
    ...
    struct Space_List const* call_90 = listMap_3(fun_39, itemTys_);
...
next_136:;
    ...
    struct UnitSpace_Fun1 fun_40 = (struct UnitSpace_Fun1){.fun = fun_20, .env = box_4};
    struct Space_ call_93 = MatchChecker_Program_spaceRef((struct String){.str = "list", .len = 4}, fun_40);
    match_25 = call_93;
    goto end_match_134;
next_137:;
    exit(1);
...
next_140:;
    ...
    struct Space_List const* call_96 = listMap_2(fun_41, itemPats_);
...
struct Space_ MatchChecker_Program_patsToSpace(struct Pat_List const* pats_) {
    ...
    struct Space_List const* call_105 = listMap_2(fun_42, pats_);
...
char MatchChecker_Program_testSpaceIsEmpty(char arg_94) {
    ...
    struct Space_ call_113 = MatchChecker_Program_spaceRef((struct String){.str = "ref", .len = 3}, fun_43);
...
char MatchChecker_Program_testSpaceToString(char arg_96) {
    struct StringSpace_Tuple2 tuple_6 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "empty", .len = 5}, .t1 = MatchChecker_Program_spaceEmpty};
    struct StringSpace_Tuple2 tuple_7 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "full", .len = 4}, .t1 = MatchChecker_Program_spaceFull};
    struct Space_ call_128 = MatchChecker_Program_spaceCtor((struct String){.str = "nil", .len = 3}, NULL);
    struct StringSpace_Tuple2 tuple_8 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "nil", .len = 3}, .t1 = call_128};
    ...
    struct StringSpace_Tuple2 tuple_9 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "tuple(empty, full)", .len = 18}, .t1 = call_129};
    struct Space_ call_130 = MatchChecker_Program_tyToSpace((struct Ty_){.discriminant = Int_});
    struct StringSpace_Tuple2 tuple_10 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "full", .len = 4}, .t1 = call_130};
    ...
    struct StringSpace_Tuple2 tuple_11 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "+(nil, cons(full, list))", .len = 24}, .t1 = call_132};
    struct Pat_Pat_Tuple2 tuple_13 = (struct Pat_Pat_Tuple2){.t0 = (struct Pat_){.discriminant = Discard_}, .t1 = (struct Pat_){.discriminant = Nil_}};
    void const* box_8 = milone_mem_alloc(1, sizeof(struct Pat_Pat_Tuple2));
    (*(((struct Pat_Pat_Tuple2*)box_8))) = tuple_13;
    ...
    struct StringSpace_Tuple2 tuple_12 = (struct StringSpace_Tuple2){.t0 = (struct String){.str = "cons(full, nil)", .len = 15}, .t1 = call_133};
    struct StringSpace_Tuple2List const* list_36 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_36))) = (struct StringSpace_Tuple2List){.head = tuple_12, .tail = NULL};
    struct StringSpace_Tuple2List const* list_35 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_35))) = (struct StringSpace_Tuple2List){.head = tuple_11, .tail = list_36};
    struct StringSpace_Tuple2List const* list_34 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_34))) = (struct StringSpace_Tuple2List){.head = tuple_10, .tail = list_35};
    struct StringSpace_Tuple2List const* list_31 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_31))) = (struct StringSpace_Tuple2List){.head = tuple_9, .tail = list_34};
    struct StringSpace_Tuple2List const* list_30 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_30))) = (struct StringSpace_Tuple2List){.head = tuple_8, .tail = list_31};
    struct StringSpace_Tuple2List const* list_29 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_29))) = (struct StringSpace_Tuple2List){.head = tuple_7, .tail = list_30};
    struct StringSpace_Tuple2List const* list_28 = milone_mem_alloc(1, sizeof(struct StringSpace_Tuple2List));
    (*(((struct StringSpace_Tuple2List*)list_28))) = (struct StringSpace_Tuple2List){.head = tuple_6, .tail = list_29};
    ...
    struct BoolList const* call_134 = listMap_1(fun_45, cases_);
    bool call_135 = listForAll_(fun_44, call_134);
    bool ok_ = call_135;
...
if_next_148:;
    ...
    struct Covering_Covering_Tuple2 tuple_14 = (struct Covering_Covering_Tuple2){.t0 = covering_, .t1 = actual_1};
    if ((tuple_14.t0.discriminant != Covering_)) goto next_153;
    if ((tuple_14.t1.discriminant != Covering_)) goto next_153;
    goto match_body_152;
next_153:;
    if ((tuple_14.t0.discriminant != Open_)) goto next_154;
    if ((tuple_14.t1.discriminant != Open_)) goto next_154;
    goto match_body_152;
match_body_152:;
    struct BoolStringTuple2 tuple_15 = (struct BoolStringTuple2){.t0 = true, .t1 = (struct String){.str = "OK", .len = 2}};
    match_27 = tuple_15;
    goto end_match_151;
next_154:;
    if ((tuple_14.t0.discriminant != Covering_)) goto next_155;
    if ((tuple_14.t1.discriminant != Open_)) goto next_155;
    struct BoolStringTuple2 tuple_16 = (struct BoolStringTuple2){.t0 = false, .t1 = (struct String){.str = "NG. Expected covering but open", .len = 30}};
    match_27 = tuple_16;
    goto end_match_151;
next_155:;
    struct BoolStringTuple2 tuple_17 = (struct BoolStringTuple2){.t0 = false, .t1 = (struct String){.str = "NG. Expected open but covering", .len = 30}};
    match_27 = tuple_17;
    goto end_match_151;
next_156:;
end_match_151:;
...
int milone_main() {
    ...
    struct Pat_Pat_Tuple2 tuple_18 = (struct Pat_Pat_Tuple2){.t0 = (struct Pat_){.discriminant = Discard_}, .t1 = (struct Pat_){.discriminant = Discard_}};
    void const* box_9 = milone_mem_alloc(1, sizeof(struct Pat_Pat_Tuple2));
    (*(((struct Pat_Pat_Tuple2*)box_9))) = tuple_18;
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_19 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "unit with ()", .len = 12}, .t1 = variant_10, .t2 = list_38, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_20 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int with literal pats", .len = 21}, .t1 = (struct Ty_){.discriminant = Int_}, .t2 = list_40, .t3 = (struct Covering_){.discriminant = Open_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_21 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int with _", .len = 10}, .t1 = (struct Ty_){.discriminant = Int_}, .t2 = list_42, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_22 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int with 1|_", .len = 12}, .t1 = (struct Ty_){.discriminant = Int_}, .t2 = list_44, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_23 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int * unit with _, ()", .len = 21}, .t1 = variant_15, .t2 = list_49, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_24 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int * int with 1, _ | _, 1", .len = 26}, .t1 = variant_18, .t2 = list_55, .t3 = (struct Covering_){.discriminant = Open_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_25 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int list with []", .len = 16}, .t1 = variant_23, .t2 = list_62, .t3 = (struct Covering_){.discriminant = Open_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_26 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int list with _::_", .len = 18}, .t1 = variant_24, .t2 = list_64, .t3 = (struct Covering_){.discriminant = Open_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_27 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int list with [] | _::_", .len = 23}, .t1 = variant_25, .t2 = list_66, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct Pat_Pat_Tuple2 tuple_29 = (struct Pat_Pat_Tuple2){.t0 = (struct Pat_){.discriminant = Discard_}, .t1 = (struct Pat_){.discriminant = Nil_}};
    void const* box_14 = milone_mem_alloc(1, sizeof(struct Pat_Pat_Tuple2));
    (*(((struct Pat_Pat_Tuple2*)box_14))) = tuple_29;
    struct Pat_ variant_27 = (struct Pat_){.discriminant = Cons_, .Cons_ = box_14};
    struct Pat_Pat_Tuple2 tuple_30 = (struct Pat_Pat_Tuple2){.t0 = (struct Pat_){.discriminant = Discard_}, .t1 = anyConsPat_};
    void const* box_15 = milone_mem_alloc(1, sizeof(struct Pat_Pat_Tuple2));
    (*(((struct Pat_Pat_Tuple2*)box_15))) = tuple_30;
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_28 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int list with [] | [_] | _::_::_", .len = 32}, .t1 = variant_26, .t2 = list_69, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct Pat_Pat_Tuple2 tuple_32 = (struct Pat_Pat_Tuple2){.t0 = (struct Pat_){.discriminant = Nil_}, .t1 = (struct Pat_){.discriminant = Nil_}};
    void const* box_18 = milone_mem_alloc(1, sizeof(struct Pat_Pat_Tuple2));
    (*(((struct Pat_Pat_Tuple2*)box_18))) = tuple_32;
    struct Pat_ variant_31 = (struct Pat_){.discriminant = Cons_, .Cons_ = box_18};
    struct Pat_Pat_Tuple2 tuple_33 = (struct Pat_Pat_Tuple2){.t0 = anyConsPat_, .t1 = (struct Pat_){.discriminant = Discard_}};
    void const* box_19 = milone_mem_alloc(1, sizeof(struct Pat_Pat_Tuple2));
    (*(((struct Pat_Pat_Tuple2*)box_19))) = tuple_33;
    ...
    (*(((struct Pat_Pat_Tuple2*)box_20))) = tuple_34;
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_31 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int list list with [] | [[]] | [_::_] | _::_::_", .len = 47}, .t1 = variant_30, .t2 = list_73, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    struct StringTy_Pat_ListCovering_Tuple4 tuple_35 = (struct StringTy_Pat_ListCovering_Tuple4){.t0 = (struct String){.str = "int list * int list with [], [] | [], _::_ | _::_, [] | _::_, _::_", .len = 66}, .t1 = variant_36, .t2 = list_80, .t3 = (struct Covering_){.discriminant = Covering_}};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_77))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_35, .tail = NULL};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_72))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_31, .tail = list_77};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_68))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_28, .tail = list_72};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_65))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_27, .tail = list_68};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_63))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_26, .tail = list_65};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_61))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_25, .tail = list_63};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_52))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_24, .tail = list_61};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_46))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_23, .tail = list_52};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_43))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_22, .tail = list_46};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_41))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_21, .tail = list_43};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_39))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_20, .tail = list_41};
    ...
    (*(((struct StringTy_Pat_ListCovering_Tuple4List*)list_37))) = (struct StringTy_Pat_ListCovering_Tuple4List){.head = tuple_19, .tail = list_39};
    ...
    struct BoolList const* call_145 = listMap_(fun_47, testCases_);
    bool call_146 = listForAll_(fun_46, call_145);
    bool ok_1 = call_146;
    int if_9;
    if (ok_1) {
        goto then_161;
