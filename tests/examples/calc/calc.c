...
struct Token_ListIntTuple2 readInt_(struct String source_3, struct Token_ListIntTuple2 arg_19) {
    ...
    int n_ = call_12;
    struct Token_ variant_ = ((struct Token_){.discriminant = TkInt_, .payload = {.TkInt_ = n_}});
...
else_65:;
    ...
    struct Token_ variant_1 = ((struct Token_){.discriminant = TkOp_, .payload = {.TkOp_ = c_2}});
...
next_68:;
    ...
    int n_1 = tokens_->head.payload.TkInt_;
...
next_69:;
    ...
    char c_3 = tokens_->head.payload.TkOp_;
...
struct IntToken_ListTuple2 evalTerm_(struct Token_List const* tokens_4) {
    ...
    int n_2 = tokens_4->head.payload.TkInt_;
...
next_72:;
    ...
    if ((tokens_4->head.payload.TkOp_ != '(')) goto next_73;
    ...
    if ((call_20.t1->head.payload.TkOp_ != ')')) goto next_76;
...
tailrec_78:;
    ...
    if ((tokens_9->head.payload.TkOp_ != '*')) goto next_80;
...
tailrec_82:;
    ...
    if ((tokens_14->head.payload.TkOp_ != '+')) goto next_84;
...
next_84:;
    ...
    if ((tokens_14->head.payload.TkOp_ != '-')) goto next_85;
