...
struct StringStringStringFun2 segItemTypeToAppend_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 arg_73);

struct IntIntIntFun2 segItemTypeToAppend_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 arg_74);

struct IntIntIntObjectUnitTuple5 segItemTypeToEmptyNode_1(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 arg_75);

struct StringIntIntObjectUnitTuple5 segItemTypeToEmptyNode_(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 arg_76);

void const* segItemTypeToNoChildren_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 arg_77);

void const* segItemTypeToNoChildren_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 arg_78);

int segItemTypeToEmptyItem_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_4);

bool listIsEmpty_(struct StringList const*);

bool listIsEmpty_3(struct StringStringStringFun2List const*);

struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 segItemTypeNew_1(struct String emptyItem_, struct StringStringStringFun2 append_1);

bool listIsEmpty_2(struct IntList const*);

bool listIsEmpty_1(struct IntIntIntFun2List const*);

struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 segItemTypeNew_(int emptyItem_, struct IntIntIntFun2 append_1);

struct StringIntIntObjectUnitTuple5 segNodeNewEmpty_1(struct String emptyItem_1);

struct IntIntIntObjectUnitTuple5 segNodeNewEmpty_(int emptyItem_1);

struct IntIntIntObjectUnitTuple5 segNodeNewLeaf_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_6, int item_1);

struct StringIntIntObjectUnitTuple5 segNodeNewLeaf_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_6, struct String item_1);
...
struct IntIntIntObjectUnitTuple5 segNodeNew_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_7, struct IntIntIntObjectUnitTuple5 left_, struct IntIntIntObjectUnitTuple5 right_);

struct StringIntIntObjectUnitTuple5 segNodeNew_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_7, struct StringIntIntObjectUnitTuple5 left_, struct StringIntIntObjectUnitTuple5 right_);

int segNodeToItem_(struct IntIntIntObjectUnitTuple5 node_);

int segNodeToLength_(struct IntIntIntObjectUnitTuple5 node_1);

int segNodeToLength_1(struct StringIntIntObjectUnitTuple5 node_1);

int segNodeToHeight_(struct IntIntIntObjectUnitTuple5 node_2);

int segNodeToHeight_1(struct StringIntIntObjectUnitTuple5 node_2);

bool listIsEmpty_4(struct IntIntIntObjectUnitTuple5List const*);

struct IntIntIntObjectUnitTuple5IntIntIntObjectUnitTuple5Tuple2 segNodeToChildren_(struct IntIntIntObjectUnitTuple5 node_3);

bool listIsEmpty_5(struct StringIntIntObjectUnitTuple5List const*);

struct StringIntIntObjectUnitTuple5StringIntIntObjectUnitTuple5Tuple2 segNodeToChildren_1(struct StringIntIntObjectUnitTuple5 node_3);

bool segNodeIsEmpty_(struct IntIntIntObjectUnitTuple5 node_4);

struct IntIntIntObjectUnitTuple5 segNodeWithLeft_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_8, struct IntIntIntObjectUnitTuple5 newLeft_, struct IntIntIntObjectUnitTuple5 node_5);

struct StringIntIntObjectUnitTuple5 segNodeWithLeft_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_8, struct StringIntIntObjectUnitTuple5 newLeft_, struct StringIntIntObjectUnitTuple5 node_5);

struct IntIntIntObjectUnitTuple5 segNodeWithRight_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_9, struct IntIntIntObjectUnitTuple5 newRight_, struct IntIntIntObjectUnitTuple5 node_6);

struct StringIntIntObjectUnitTuple5 segNodeWithRight_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_9, struct StringIntIntObjectUnitTuple5 newRight_, struct StringIntIntObjectUnitTuple5 node_6);
...
struct IntIntIntObjectUnitTuple5 segNodeMakeBalanced_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_10, struct IntIntIntObjectUnitTuple5 node_7);

struct StringIntIntObjectUnitTuple5 segNodeMakeBalanced_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_10, struct StringIntIntObjectUnitTuple5 node_7);

struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreeNew_1(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_11);

struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 segTreeNew_(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_11);

struct IntIntIntObjectUnitTuple5 segTreeToRoot_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_4);

struct StringIntIntObjectUnitTuple5 segTreeToRoot_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 self_4);

int segTreeToLength_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_5);

int segTreeToLength_1(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 self_5);

int segTreeToHeight_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_6);
...
int segTreeGet_(int index_5, struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_8);

struct String segTreeGet_1(int index_5, struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 self_8);
...
int segTreeSum_(int ql_, int qr_, struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_9);
...
struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreeSet_(int index_7, int newItem_, struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_10);
...
struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreeInsert_(int index_9, int newItem_1, struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_11);

struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 segTreeInsert_1(int index_9, struct String newItem_1, struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 self_11);
...
struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreeRemove_(int index_11, struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_12);

struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 segTreePush_1(struct String value_4, struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 self_13);

struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreePush_(int value_4, struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_13);

struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreePop_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 self_14);
...
struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 segTreeOfList_(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4 itemTy_16, struct IntList const* xs_21);
...
struct IntList const* segTreeToList_1(struct IntIntIntFun2IntIntIntObjectUnitTuple5ObjectUnitTuple4IntIntIntObjectUnitTuple5UnitTuple3 v_4);

struct StringList const* segTreeToList_(struct StringStringStringFun2StringIntIntObjectUnitTuple5ObjectUnitTuple4StringIntIntObjectUnitTuple5UnitTuple3 v_4);
