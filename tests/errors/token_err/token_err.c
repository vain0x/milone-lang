#error token_err.token_err:4:2 Undefined operator.
#error token_err.token_err:7:1 This word can't be used as identifier, because it's reserved for future expansion of the language.
#error token_err.token_err:10:1 This word can't be used as identifier, because it's reserved for future expansion of the language.
#error token_err.token_err:13:1 This word can't be used as identifier, because it's reserved for future expansion of the language.
