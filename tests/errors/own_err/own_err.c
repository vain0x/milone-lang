...
#error own_err.own_err:84:11 Functions that take a value of owned type can't be partially applied.
...
#error own_err.own_err:137:32 This variant of owned type is invalid for now. This error happens when a union contains another owned union type. Consider to use the Own type directly.
