#error pat_or_asymmetric_err:6:3 OR pattern including some bindings is unimplemented.
...
#error pat_or_asymmetric_err:15:3 OR pattern including some bindings is unimplemented.
