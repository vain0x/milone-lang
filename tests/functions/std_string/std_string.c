...
int isEmptyTest_(int arg_41) {
    ...
    milone_assert(call_43, 16, 2);
    bool call_44 = isEmpty_1((struct String){.str = "\0", .len = 1});
    milone_assert((!(call_44)), 17, 2);
    return 0;
}
...
int splitTest_(int arg_53) {
    ...
    milone_assert((str_cmp(call_108, (struct String){.str = "a;b;c", .len = 5}) == 0), 92, 2);
    ...
    milone_assert((str_cmp(call_110, (struct String){.str = "a;b;c;", .len = 6}) == 0), 93, 2);
    ...
    milone_assert((str_cmp(call_112, (struct String){.str = "a", .len = 1}) == 0), 94, 2);
    ...
    milone_assert((str_cmp(call_114, (struct String){.str = ";", .len = 1}) == 0), 95, 2);
    ...
    milone_assert((str_cmp(call_116, (struct String){.str = "", .len = 0}) == 0), 96, 2);
    return 0;
}
...
int concatTest_(int arg_54) {
    ...
    milone_assert((str_cmp(call_117, (struct String){.str = "ab, cd, ef", .len = 10}) == 0), 99, 2);
    struct String call_118 = concat_((struct String){.str = "", .len = 0}, NULL);
    milone_assert((str_cmp(call_118, (struct String){.str = "", .len = 0}) == 0), 100, 2);
    return 0;
}
