...
int main() {
    struct F64List* list_7 = milone_mem_alloc(1, sizeof(struct F64List));
    list_7->head = 00.00e-00;
    list_7->tail = NULL;
    struct F64List* list_6 = milone_mem_alloc(1, sizeof(struct F64List));
    list_6->head = 0E-9;
    list_6->tail = list_7;
    struct F64List* list_5 = milone_mem_alloc(1, sizeof(struct F64List));
    list_5->head = 0E+9;
    list_5->tail = list_6;
    struct F64List* list_4 = milone_mem_alloc(1, sizeof(struct F64List));
    list_4->head = 0E0;
    list_4->tail = list_5;
    struct F64List* list_3 = milone_mem_alloc(1, sizeof(struct F64List));
    list_3->head = 0e0;
    list_3->tail = list_4;
    struct F64List* list_2 = milone_mem_alloc(1, sizeof(struct F64List));
    list_2->head = 000.000;
    list_2->tail = list_3;
    struct F64List* list_1 = milone_mem_alloc(1, sizeof(struct F64List));
    list_1->head = 0.;
    list_1->tail = list_2;
    struct F64List* list_ = milone_mem_alloc(1, sizeof(struct F64List));
    list_->head = 0.0;
    list_->tail = list_1;
    ...
    struct F64List* list_18 = milone_mem_alloc(1, sizeof(struct F64List));
    list_18->head = 6.02e-23;
    list_18->tail = NULL;
    struct F64List* list_17 = milone_mem_alloc(1, sizeof(struct F64List));
    list_17->head = 1e-23;
    list_17->tail = list_18;
    struct F64List* list_16 = milone_mem_alloc(1, sizeof(struct F64List));
    list_16->head = 1e+23;
    list_16->tail = list_17;
    struct F64List* list_15 = milone_mem_alloc(1, sizeof(struct F64List));
    list_15->head = 1E-9;
    list_15->tail = list_16;
    struct F64List* list_14 = milone_mem_alloc(1, sizeof(struct F64List));
    list_14->head = 1e-9;
    list_14->tail = list_15;
    struct F64List* list_13 = milone_mem_alloc(1, sizeof(struct F64List));
    list_13->head = 1E+9;
    list_13->tail = list_14;
    struct F64List* list_12 = milone_mem_alloc(1, sizeof(struct F64List));
    list_12->head = 1e+9;
    list_12->tail = list_13;
    struct F64List* list_11 = milone_mem_alloc(1, sizeof(struct F64List));
    list_11->head = 1E9;
    list_11->tail = list_12;
    struct F64List* list_10 = milone_mem_alloc(1, sizeof(struct F64List));
    list_10->head = 1e9;
    list_10->tail = list_11;
    struct F64List* list_9 = milone_mem_alloc(1, sizeof(struct F64List));
    list_9->head = 42.195;
    list_9->tail = list_10;
    struct F64List* list_8 = milone_mem_alloc(1, sizeof(struct F64List));
    list_8->head = 1.0;
    list_8->tail = list_9;
